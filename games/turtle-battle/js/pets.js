...
const ALL_PETS = [
  ...
  { id:'bamboo',    name:'竹叶龟',   emoji:'🎋🐢',    rarity:'C',   hp:300,  atk:40,  def:10, spd:12, crit:0.25,
    ...
    passive:{ type:'bambooCharge', atkPct:85, selfHpPct:12, healSelfHpPct:7, hpGainAtkPct:35,
              desc:'每隔1回合充能🎋，充能回合技能释放后追加一发强化普攻：造成 {P:ATK*0.85+HP*0.12} 穿透伤害(85%ATK+12%最大HP)，回复 {H:HP*0.07} HP(7%最大HP)，并永久增加 {H:ATK*0.35} 最大生命值(35%ATK)' },
    skills:[
      ...
      { name:'自然恢复', type:'bambooHeal', hits:1, power:0, pierce:0, cd:3, healPct:10, shieldPct:13, shieldTurns:3, soloHealPct:20,
        brief:'竹叶龟回复{H:HP*0.1}HP，队友获得{S:HP*0.13}护盾3回合（无队友则回复{H:HP*0.2}）',
        detail:'竹叶龟回复 10%×(最大HP={HP}) = {H:HP*0.1} HP。\n为存活队友施加 13%×(最大HP={HP}) = {S:HP*0.13} 护盾，持续3回合。\n如果没有存活队友，改为回复 20%×(最大HP={HP}) = {H:HP*0.2} HP。\n冷却{cd}回合。' },
    ]},
  // B级
  ...
  { id:'ice',       name:'寒冰龟',   emoji:'❄️🐢',    rarity:'B',   hp:370,  atk:38,  def:16, spd:9, crit:0.25,
    ...
    skills:[
      { name:'冰锥', type:'iceSpike', hits:6, power:0, pierce:0, cd:0, totalScale:1.3,
        brief:'寒冰龟发射6段冰锥，普通/穿透交替，共{N:1.3*ATK}混合伤害',
        detail:'寒冰龟对单体发射6段冰锥，奇数段造成普通伤害，偶数段造成穿透伤害。\n共 130%×(攻击力={ATK}) = {N:1.3*ATK} 混合伤害。' },
      ...
      { name:'冰霜', type:'iceFrost', hits:1, power:0, pierce:0, cd:4, atkScale:1.1,
        brief:'寒冰龟对全体敌方造成{P:1.1*ATK}穿透伤害',
        detail:'寒冰龟释放冰霜，对全体敌方造成 110%×(攻击力={ATK}) = {P:1.1*ATK} 穿透伤害。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'diamond',   name:'钻石龟',   emoji:'💎🐢',    rarity:'B',   hp:350,  atk:35,  def:20, spd:8, crit:0.25,
    ...
    passive:{ type:'diamondStructure', defBuffAmp:50, flatReductionPct:10,
              desc:'防御加成额外+{defBuffAmp}%；每段受伤减少 10%×(防御={DEF}) = {N:DEF*0.1} 固定值（穿透除外）' },
    skills:[
      { name:'钻石切割', type:'physical', hits:1, power:0, pierce:0, cd:0, atkScale:0.7, defScale:1.0,
        brief:'钻石龟切割敌方，造成{N:0.7*ATK}+{N:DEF}普通伤害',
        detail:'钻石龟对单体造成 70%×(攻击力={ATK}) = {N:0.7*ATK} + 100%×(防御={DEF}) = {N:DEF} 普通伤害。\n防御越高伤害越高。' },
      { name:'坚不可摧', type:'diamondFortify', hits:1, power:0, pierce:0, cd:3, shieldHpPct:15, shieldTurns:3, defUpAtkPct:20, defUpTurns:3,
        brief:'钻石龟获得{S:HP*0.15}护盾3回合 + 防御+{B:ATK*0.2}（被动放大后+{B:ATK*0.3}）3回合',
        detail:'钻石龟获得 15%×(最大HP={HP}) = {S:HP*0.15} 护盾，持续3回合。\n防御提升 20%×(攻击力={ATK}) = {B:ATK*0.2}点，持续3回合。\n被动钻石结构放大50% → 实际获得 {B:ATK*0.3}点防御。\n冷却{cd}回合。' },
      { name:'碰撞', type:'diamondCollide', hits:1, power:0, pierce:0, cd:3, atkScale:0.8, defScale:1.5, selfHpPct:10, stunAfter:2,
        brief:'钻石龟撞击敌方，造成{N:0.8*ATK}+{N:1.5*DEF}+{N:HP*0.1}普通伤害，被撞2次眩晕1回合',
        detail:'钻石龟全身撞击单体，造成 80%×(攻击力={ATK}) = {N:0.8*ATK} + 150%×(防御={DEF}) = {N:1.5*DEF} + 10%×(最大HP={HP}) = {N:HP*0.1} 普通伤害。\n同一目标累计被碰撞{stunAfter}次→眩晕1回合（跳过行动，被动仍生效）。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'rainbow',   name:'彩虹龟',   emoji:'🌈🐢',    rarity:'A',   hp:340,  atk:40,  def:14, spd:12, crit:0.25,
    ...
    passive:{ type:'rainbowPrism', atkPct:15, defPct:15, healPct:10, desc:'每回合随机为全体友方附加增益1回合：红+{atkPct}%ATK / 蓝+{defPct}%DEF / 绿回复{healPct}%最大HP' },
    skills:[
      ...
      { name:'棱镜护盾', type:'shield', hits:1, power:0, pierce:0, cd:3, shieldAtkScale:0.55, aoeAlly:true,
        brief:'彩虹龟为全体友方施加{S:0.55*ATK}护盾',
        detail:'彩虹龟用棱镜之光保护全体友方。\n每人获得 55%×(攻击力={ATK}) = {S:0.55*ATK} 护盾。\n冷却{cd}回合。' },
  ...
  { id:'candy',     name:'糖果龟',   emoji:'🍬🐢',    rarity:'A',   hp:340,  atk:38,  def:14, spd:11, crit:0.25,
    ...
    passive:{ type:'candySteal', stealTurn:5, stealPct:18, desc:'登场5回合后，偷取随机敌人18%最大生命值加给自己（敌人最大HP和当前HP同步减少）' },
    skills:[
  ...
  { id:'bubble',    name:'泡泡龟',   emoji:'🫧🐢',    rarity:'A',   hp:320,  atk:40,  def:11, spd:13, crit:0.25,
    ...
    passive:{ type:'bubbleStore', pct:70, healPct:40, desc:'受伤储存70%为泡泡值，每回合回复储存值40%' },
    skills:[
      { name:'泡泡盾',   type:'bubbleShield', hits:1, power:0, pierce:0, cd:3, atkScale:2.0, duration:3, burstScale:1.4,
        brief:'泡泡龟为友方施加{S:atkScale*ATK}泡泡护盾{duration}回合，到期爆炸对敌全体造成{N:burstScale*ATK}普通伤害',
        detail:'泡泡龟为友方单体套上 200%×(攻击力={ATK}) = {S:atkScale*ATK} 泡泡护盾（与普通护盾独立），持续{duration}回合。\n自然到期（未被打破）时对全体敌方造成 140%×(攻击力={ATK}) = {N:burstScale*ATK} 普通伤害。\n冷却{cd}回合。' },
      { name:'泡泡攻击', type:'magic', hits:3, power:0, pierce:0, cd:0, atkScale:0.45,
        brief:'泡泡龟攻击3段，共{N:0.45*ATK*3}普通伤害',
        detail:'每段造成 45%×(攻击力={ATK}) = {N:0.45*ATK} 普通伤害 × 3段 = {N:0.45*ATK*3}' },
      { name:'泡泡束缚', type:'bubbleBind', hits:1, power:0, pierce:0, cd:4, duration:4, bindPct:30,
  ...
  { id:'lightning', name:'闪电龟',   emoji:'⚡🐢',    rarity:'A',   hp:310,  atk:43,  def:9,  spd:17, crit:0.25,
    ...
    passive:{ type:'lightningStorm', shockScale:0.9, stackMax:8, desc:'每回合电击随机敌人 100%×(攻击力={ATK}) = {P:ATK} 穿透；造成伤害叠电击层，满8层触发 90%×ATK = {P:ATK*0.9} 穿透' },
    skills:[
      { name:'闪电打击', type:'lightningStrike', hits:5, power:0, pierce:0, cd:0, atkScale:0.24, splashPct:25,
        brief:'闪电龟打击5段，共{N:0.24*ATK*5}普通伤害，每段溅射{splashPct}%到次目标',
        detail:'闪电龟对单体目标打击5段，每段造成 24%×(攻击力={ATK}) = {N:0.24*ATK} 普通伤害，共 120%×(攻击力={ATK}) = {N:0.24*ATK*5} 普通伤害。\n每段对次目标造成主目标 {splashPct}% 溅射伤害。每段命中叠1层电击。' },
      ...
      { name:'雷暴',     type:'lightningBarrage', hits:20, power:0, pierce:0, cd:5, arrowScale:0.12,
        brief:'闪电龟释放{hits}次闪电随机命中敌方，每次{N:arrowScale*ATK}普通伤害，每次叠电击层',
        detail:'释放{hits}次闪电，随机分布到敌方。\n每次造成 12%×(攻击力={ATK}) = {N:arrowScale*ATK} 普通伤害。每次命中叠1层电击。\n冷却{cd}回合。' },
    ]},
  // S级
  ...
  { id:'chest',     name:'宝箱龟',   emoji:'📦🐢',    rarity:'S',   hp:360,  atk:39,  def:15, spd:10, crit:0.25,
    ...
    skills:[
      ...
      { name:'财宝风暴', type:'physical', hits:6, power:0, pierce:0, cd:4, atkScale:0.2, pierceScale:0.13, atkDown:{pct:15,turns:2},
        brief:'宝箱龟飞射6段财宝，每段{N:0.2*ATK}普通+{P:0.13*ATK}穿透，减攻{atkDown.pct}%',
        detail:'宝箱龟飞射6段财宝。\n每段造成 20%×ATK = {N:0.2*ATK} 普通 + 13%×ATK = {P:0.13*ATK} 穿透。\n共 {N:0.2*ATK*6} 普通 + {P:0.13*ATK*6} 穿透。\n附加减攻{atkDown.pct}%持续{atkDown.turns}回合。\n冷却{cd}回合。' },
    ]},
