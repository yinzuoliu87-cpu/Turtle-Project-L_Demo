  ...
  { id:'stone',     name:'石头龟',   emoji:'🪨🐢',    rarity:'C',   hp:380,  atk:35,  def:18, mr:15, spd:6, crit:0.25,
    ...
    skills:[
      ...
      { name:'磐石',     type:'heal', hits:1, power:0, heal:0, cd:4, defUpPct:{pct:20,turns:3}, mrUpPct:{pct:20,turns:3},
        brief:'石头龟为友方提升 <span class="val-def">护甲</span>+{D:DEF*0.2} 和 <span class="val-magic">魔抗</span>+{M:MR*0.2}，持续3回合',
        detail:'石头龟为友方单体提升：\n<span class="val-def">护甲</span> +20%×({DEF}) = {D:DEF*0.2}点，持续3回合\n<span class="val-magic">魔抗</span> +20%×({MR}) = {M:MR*0.2}点，持续3回合\n冷却{cd}回合。' },
    ]},
  ...
  { id:'rainbow',   name:'彩虹龟',   emoji:'🌈🐢',    rarity:'A',   hp:340,  atk:40,  def:14, mr:16, spd:12, crit:0.25,
    ...
    skills:[
      ...
      { name:'全色风暴', type:'magic', dmgType:'magic', hits:4, power:0, pierce:0, cd:4, aoe:true, atkScale:0.2, pierceScale:0.1, defDown:{pct:20,turns:3}, burn:true,
        brief:'彩虹龟对全体敌人释放4段风暴，每段{N:0.2*ATK}魔法+{P:0.1*ATK}真实，减防20%+灼烧4回合',
