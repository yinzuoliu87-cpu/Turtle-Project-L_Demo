...
const ALL_PETS = [
  ...
  { id:'basic',     name:'小龟',     emoji:'🐢',      rarity:'C',   hp:320,  atk:39,  def:13, spd:10, crit:0.25,
  ...
  { id:'bamboo',    name:'竹叶龟',   emoji:'🎋🐢',    rarity:'C',   hp:300,  atk:40,  def:10, spd:12, crit:0.25,
    ...
    passive:{ type:'bambooCharge', atkPct:85, selfHpPct:10, healSelfHpPct:6, hpGainAtkPct:30,
              desc:'每隔1回合充能🎋，充能回合技能释放后追加一发强化普攻：造成 {P:ATK*0.85+HP*0.1} 穿透伤害(85%ATK+10%最大HP)，回复 {H:HP*0.06} HP(6%最大HP)，并永久增加 {H:ATK*0.3} 最大生命值(30%ATK)' },
    skills:[
      { name:'一叶刃', type:'bambooLeaf', hits:3, power:0, pierce:0, cd:0, atkScale:0.21, selfHpPct:5,
        brief:'竹叶龟甩出3片叶刃，每段{N:0.21*ATK}+5%最大HP普通伤害',
        detail:'竹叶龟对单体甩出3片叶刃。\n每段造成 21%×(攻击力={ATK}) = {N:0.21*ATK} + 5%×(最大HP={HP}) = {N:HP*0.05} 普通伤害。\n共 {N:0.21*ATK*3+HP*0.05*3} 普通伤害。' },
      { name:'自然恢复', type:'bambooHeal', hits:1, power:0, pierce:0, cd:3, healPct:9, shieldPct:12, shieldTurns:3, soloHealPct:15,
        brief:'竹叶龟回复{H:HP*0.09}HP，队友获得{S:HP*0.12}护盾3回合（无队友则回复{H:HP*0.15}）',
        detail:'竹叶龟回复 9%×(最大HP={HP}) = {H:HP*0.09} HP。\n为存活队友施加 12%×(最大HP={HP}) = {S:HP*0.12} 护盾，持续3回合。\n如果没有存活队友，改为回复 15%×(最大HP={HP}) = {H:HP*0.15} HP。\n冷却{cd}回合。' },
    ]},
  // B级
  { id:'angel',     name:'天使龟',   emoji:'😇🐢',    rarity:'B',   hp:330,  atk:40,  def:13, spd:11, crit:0.25,
    ...
    skills:[
      ...
      { name:'祝福', type:'angelBless', hits:1, power:0, pierce:0, cd:4, shieldScale:1.2, shieldTurns:4, defBoostScale:0.12, defBoostTurns:4,
      ...
      { name:'平等', type:'angelEquality', hits:2, power:0, pierce:0, cd:5, normalScale:0.6, pierceScale:0.6,
  ...
  { id:'ice',       name:'寒冰龟',   emoji:'❄️🐢',    rarity:'B',   hp:370,  atk:38,  def:16, spd:9, crit:0.25,
    ...
    skills:[
      ...
      { name:'冰霜', type:'iceFrost', hits:1, power:0, pierce:0, cd:4, atkScale:1.2,
        brief:'寒冰龟对全体敌方造成{P:1.2*ATK}穿透伤害',
        detail:'寒冰龟释放冰霜，对全体敌方造成 120%×(攻击力={ATK}) = {P:1.2*ATK} 穿透伤害。\n冷却{cd}回合。' },
    ]},
  { id:'ninja',     name:'忍者龟',   emoji:'🥷🐢',    rarity:'B',   hp:310,  atk:46,  def:9,  spd:15, crit:0.25,
  ...
  { id:'ghost',     name:'幽灵龟',   emoji:'👻🐢',    rarity:'B',   hp:300,  atk:42,  def:9,  spd:14, crit:0.25,
    ...
    skills:[
      ...
      { name:'灵魂风暴', type:'ghostStorm', hits:5, power:0, pierce:0, cd:4, pierceScale:0.35, dotScale:0.1, dotTurns:3,
  ...
  { id:'rainbow',   name:'彩虹龟',   emoji:'🌈🐢',    rarity:'A',   hp:340,  atk:40,  def:14, spd:12, crit:0.25,
    ...
    skills:[
      { name:'七彩光束', type:'magic', hits:2, power:0, pierce:0, cd:0, atkScale:0.7,
      ...
      { name:'全色风暴', type:'magic', hits:4, power:0, pierce:0, cd:4, aoe:true, atkScale:0.2, pierceScale:0.1, defDown:{pct:20,turns:3}, phoenixBurn:{turns:3, atkPct:30, hpPct:5},
  ...
  { id:'hunter',    name:'猎人龟',   emoji:'🏹🐢',    rarity:'A',   hp:320,  atk:42,  def:12, spd:14, crit:0.25,
    ...
    passive:{ type:'hunterKill', hpThresh:15, stealPct:25, lifesteal:10, desc:'任意攻击后猎杀HP<15%敌人，获取25%属性+10%吸血' },
    skills:[
      ...
      { name:'连珠箭',   type:'hunterBarrage', hits:10, power:0, pierce:0, cd:3, arrowScale:0.25,
        brief:'猎人龟发射{hits}根箭随机射向敌方，每根{P:arrowScale*ATK}穿透，每段可暴击',
        detail:'猎人龟发射{hits}根箭，随机分布到敌方。\n每根造成 25%×(攻击力={ATK}) = {P:arrowScale*ATK} 穿透伤害，每根独立判定暴击。\n共 250%×(攻击力={ATK}) = {P:arrowScale*ATK*hits} 穿透伤害。\n冷却{cd}回合。' },
      { name:'隐蔽',     type:'hunterStealth', hits:1, power:0, pierce:0, cd:4, dmgScale:0.9, dodgePct:30, dodgeTurns:3, shieldScale:1.2, shieldTurns:3,
  ...
  { id:'candy',     name:'糖果龟',   emoji:'🍬🐢',    rarity:'A',   hp:340,  atk:38,  def:14, spd:11, crit:0.25,
    ...
    skills:[
      { name:'糖果弹', type:'magic', hits:3, power:0, pierce:0, cd:0, atkScale:0.5, atkDown:{pct:15,turns:2},
      ...
      { name:'糖衣炮弹', type:'magic', hits:8, power:0, pierce:0, cd:4, atkScale:0.35, pierceScale:0.1, defDown:{pct:15,turns:2},
  ...
  { id:'bubble',    name:'泡泡龟',   emoji:'🫧🐢',    rarity:'A',   hp:320,  atk:37,  def:17, spd:13, crit:0.25,
    img:'../../assets/pets/气泡龟v1.png', sprite:{frames:8,frameW:500,frameH:500,duration:800},
    passive:{ type:'bubbleStore', pct:50, healPct:70, desc:'受伤储存50%为泡泡值，每回合回复储存值70%' },
    skills:[
      { name:'泡泡盾',   type:'bubbleShield', hits:1, power:0, pierce:0, cd:3, atkScale:2.1, duration:3, burstScale:1.7,
        brief:'泡泡龟为友方施加{S:atkScale*ATK}泡泡护盾{duration}回合，到期爆炸对敌全体造成{N:burstScale*ATK}普通伤害',
        detail:'泡泡龟为友方单体套上 210%×(攻击力={ATK}) = {S:atkScale*ATK} 泡泡护盾（与普通护盾独立），持续{duration}回合。\n自然到期（未被打破）时对全体敌方造成 170%×(攻击力={ATK}) = {N:burstScale*ATK} 普通伤害。\n冷却{cd}回合。' },
      { name:'泡泡攻击', type:'magic', hits:3, power:0, pierce:0, cd:0, atkScale:0.55,
        brief:'泡泡龟攻击3段，共{N:0.55*ATK*3}普通伤害',
        detail:'每段造成 55%×(攻击力={ATK}) = {N:0.55*ATK} 普通伤害 × 3段 = {N:0.55*ATK*3}' },
      { name:'泡泡束缚', type:'bubbleBind', hits:1, power:0, pierce:0, cd:4, duration:4, bindPct:55,
  ...
  { id:'lightning', name:'闪电龟',   emoji:'⚡🐢',    rarity:'A',   hp:310,  atk:43,  def:9,  spd:17, crit:0.25,
    ...
    skills:[
      { name:'闪电打击', type:'lightningStrike', hits:5, power:0, pierce:0, cd:0, atkScale:0.23, splashPct:25,
      ...
      { name:'雷暴',     type:'lightningBarrage', hits:20, power:0, pierce:0, cd:5, arrowScale:0.11,
  ...
  { id:'lava',      name:'熔岩龟',   emoji:'🌋🐢',    rarity:'S',   hp:380,  atk:38,  def:18, spd:7, crit:0.25,
    ...
    skills:[
      { name:'熔岩喷发', type:'magic', hits:1, power:0, pierce:0, cd:0, atkScale:0.9, phoenixBurn:{turns:3, atkPct:25, hpPct:3},
      ...
      { name:'火山爆发', type:'magic', hits:5, power:0, pierce:0, cd:4, aoe:true, atkScale:0.14, pierceScale:0.07, phoenixBurn:{turns:3, atkPct:15, hpPct:3},
  ...
  { id:'crystal',   name:'水晶龟',   emoji:'🔮🐢',    rarity:'S',   hp:350,  atk:40,  def:19, spd:11, crit:0.25,
    ...
    skills:[
      { name:'水晶刺', type:'magic', hits:2, power:0, pierce:0, cd:0, atkScale:0.5, pierceScale:0.15,
      ...
      { name:'碎晶风暴', type:'magic', hits:7, power:0, pierce:0, cd:4, atkScale:0.16, pierceScale:0.09, phoenixBurn:{turns:3, atkPct:15, hpPct:3},
