  ...
  { id:'basic',     name:'小龟',     emoji:'🐢',      rarity:'C',   hp:350,  atk:40,  def:14, mr:13,crit:0.25,
    ...
    skillPool:[
      ...
      { name:'龟派气波', type:'basicChiWave', hits:3, power:0, pierce:0, cd:6, selfCast:true, atkScale:1.5,
        ...
        brief:'自增 <span class="val-atk">+25%暴击</span> / <span class="val-atk">+20%爆伤</span> / <span class="val-heal">+10%吸血</span> / <span class="val-atk">+{N:0.1*ATK}穿甲</span> 1回合，对同行前排敌人释放气波，3段共（{N:1.5*ATK}）物理伤害',
        detail:'小龟获得 1 回合增益：\n· <span class="val-atk">+25%</span> 暴击率\n· <span class="val-atk">+20%</span> 暴击伤害\n· <span class="val-heal">+10%</span> 生命偷取\n· <span class="val-atk">+</span>（10%×攻击力 = {N:0.1*ATK}）护甲穿透\n\n镜头推近 → 蓄力 → 气波缓缓飞向与自身同行（同一横排 = 同列号）的敌人：\n· 优先命中**前排**敌人；前排阵亡时才命中后排\n· 气波触碰目标的瞬间开始 3 段连击，共（150%×攻击力({ATK}) = {N:1.5*ATK}）物理伤害，目标被击飞空中\n\n冷却{cd}回合。' },
