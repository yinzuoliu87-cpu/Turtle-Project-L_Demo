...
const ALL_PETS = [
  ...
  { id:'bubble',    name:'泡泡龟',   emoji:'🫧🐢',    rarity:'A',   hp:350,  atk:39,  def:18, mr:19, spd:14, crit:0.25,
    ...
    passive:{ type:'bubbleStore', name:'泡沫', pct:30, healPct:25, dmgPct:25,
              brief:'受伤储存 <span class="val-atk">30%</span> 为泡泡值，每回合消耗 <span class="val-heal">25%</span> 回复生命 + <span class="val-magic">25%</span> 打击随机敌人',
  ...
  { id:'cyber',     name:'赛博龟',   emoji:'🤖🐢',    rarity:'S',   hp:360,  atk:47,  def:14, mr:13, spd:16, crit:0.25,
    ...
    passive:{ type:'cyberDrone', name:'浮游炮', droneScale:0.14, droneMaxAge:5, maxDrones:10, mechHpPer:30, mechAtkPer:5,
              brief:'每回合生成浮游炮（上限10），每个每回合造成（{N:ATK*0.14}）物理伤害。阵亡时浮游炮组装为机甲',
  ...
  { id:'headless',  name:'无头龟',   emoji:'💀🐢',    rarity:'SS',  hp:370,  atk:45,  def:13, mr:12, spd:16, crit:0.25,
    img:'../../assets/pets/无头龟v1.png', sprite:{frames:17,frameW:500,frameH:500,duration:1700},
    passive:{ type:'undeadRage', name:'亡灵', lifestealBase:0, atkPerLostPct:0.5, atkMaxBonus:25,
              brief:'血量越低攻击力越高。首次濒死时锁血1HP 1回合',
              desc:'无头龟的亡灵之力。\n\n生命值越低攻击力越高：每损失1%生命值 → 攻击力 <span class="val-atk">+0.5%</span>（最高 <span class="val-atk">+25%</span>）。\n\n首次生命值归零时，触发亡灵之力：锁血1HP持续1回合。\n锁血期间生命值固定为1，不增不减，免疫真实伤害，不可被斩杀。\n锁血结束后恢复为1HP，可以被正常击杀。' },
    skills:[
      { name:'撕咬',   type:'physical', hits:2, power:0, pierce:0, cd:0, atkScale:0.5, hpPct:6,
        brief:'无头龟撕咬2段，共（{N:0.5*ATK*2}）+ 12%目标最大生命值 物理伤害',
        detail:'无头龟对单体撕咬2段。\n每段造成（50%×攻击力({ATK}) = {N:0.5*ATK}）+ 6%目标最大生命值 物理伤害。\n共（100%×攻击力({ATK}) = {N:0.5*ATK*2}）+ 12%目标最大生命值 物理伤害。' },
      { name:'恐吓',   type:'twoHeadFear', hits:1, power:0, pierce:0, cd:3, atkScale:1.1, fearTurns:3, fearReduction:30,
        brief:'无头龟造成（{N:1.1*ATK}）物理伤害，施加恐惧3回合（对无头龟伤害 <span class="val-atk">-30%</span>）',
        detail:'无头龟对单体造成（110%×攻击力({ATK}) = {N:1.1*ATK}）物理伤害。\n施加恐惧3回合：被恐惧目标对无头龟的伤害减少 <span class="val-atk">30%</span>（真实伤害除外）。\n冷却{cd}回合。' },
      { name:'灵魂收割', type:'soulReap', hits:1, power:0, pierce:0, cd:4, aoe:true, atkScale:0.8, lostHpPct:15,
        brief:'无头龟对全体敌方造成（{N:0.8*ATK}）+ 15%已损生命值 物理伤害',
        detail:'无头龟对全体敌方造成（80%×攻击力({ATK}) = {N:0.8*ATK}）+ 15%已损生命值 物理伤害。\n冷却{cd}回合。' },
    ]},
  // SSS级
