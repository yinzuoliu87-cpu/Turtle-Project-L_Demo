...
const ALL_PETS = [
  ...
  { id:'basic',     name:'小龟',     emoji:'🐢',      rarity:'C',   hp:350,  atk:40,  def:14, mr:13, spd:10, crit:0.25,
    ...
    skillPool:[
      ...
      { name:'团队回复', type:'basicRam', hits:0, power:0, pierce:0, cd:4, aoeAlly:true, shieldScale:0.7,
        brief:'小龟为所有友军回复（{S:0.7*ATK}）护盾值',
        detail:'小龟为全体友方施加（70%×攻击力({ATK}) = {S:0.7*ATK}）护盾值。\n冷却{cd}回合。' },
  ...
  { id:'stone',     name:'石头龟',   emoji:'🪨🐢',    rarity:'C',   hp:380,  atk:36,  def:18, mr:15, spd:6, crit:0.25,
    ...
    skillPool:[
      ...
      { name:'地震',     type:'stoneQuake', hits:1, power:0, pierce:0, cd:5, aoe:true, atkScale:0.4, defScale:0.8, stunChance:30,
  ...
  { id:'ice',       name:'寒冰龟',   emoji:'❄️🐢',    rarity:'B',   hp:381,  atk:41,  def:16, mr:18, spd:9, crit:0.25,
    ...
    skillPool:[
      ...
      { name:'团队护盾', type:'iceTeamShield', hits:0, power:0, pierce:0, cd:3, aoeAlly:true, shieldScale:0.5, shieldTurns:3,
        brief:'寒冰龟为全体友军施加（{S:0.5*ATK}）护盾，持续3回合',
        detail:'寒冰龟为全体友军施加（50%×攻击力({ATK}) = {S:0.5*ATK}）护盾，持续3回合。\n冷却{cd}回合。' },
    ], defaultSkills:[0,1,2], skills:[]
  },
  { id:'ninja',     name:'忍者龟',   emoji:'🥷🐢',    rarity:'B',   hp:329,  atk:47,  def:9,  mr:7, spd:15, crit:0.25,
    ...
    skillPool:[
      ...
      { name:'影分身', type:'ninjaClone', hits:3, power:0, pierce:0, cd:4, atkScale:0.5, dodgePct:30, dodgeTurns:2,
        brief:'忍者龟分身突击3段，共（{N:0.5*ATK*3}）物理伤害，获得 <span class="val-atk">30%</span> 闪避2回合',
        detail:'忍者龟使用影分身术对单体突击3段，每段（50%×攻击力({ATK}) = {N:0.5*ATK}）物理伤害。\n共（{N:0.5*ATK*3}）物理伤害。\n获得 <span class="val-atk">30%</span> 闪避率，持续2回合。\n冷却{cd}回合。' },
  ...
  { id:'two_head',  name:'双头龟',   emoji:'🐢🐢',    rarity:'B',   hp:302,  atk:50,  def:11, mr:12, spd:7, crit:0.25,
    ...
    skillPool:[
      ...
      { name:'融合', type:'twoHeadFusion', passiveSkill:true, hits:0, power:0, pierce:0, cd:0,
        brief:'携带后不可切换形态，但获得原本近战形态的额外最大生命值与护甲魔抗',
  ...
  { id:'lightning', name:'闪电龟',   emoji:'⚡🐢',    rarity:'A',   hp:329,  atk:42,  def:10, mr:13, spd:18, crit:0.25,
    ...
    skillPool:[
      ...
      { name:'团队鼓舞', type:'lightningBuff', hits:1, power:0, pierce:0, cd:4, atkUpPct:20, atkUpTurns:3,
        brief:'闪电龟为全体友方施加 <span class="val-atk">+20%攻击力</span> 3回合',
        detail:'闪电龟为全体友方施加 +20% 攻击力加成，持续3回合。\n冷却{cd}回合。' },
