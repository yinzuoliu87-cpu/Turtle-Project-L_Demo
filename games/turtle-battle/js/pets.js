...
const ALL_PETS = [
  ...
  { id:'bamboo',    name:'竹叶龟',   emoji:'🎋🐢',    rarity:'C',   hp:300,  atk:40,  def:10, spd:12, crit:0.25,
    ...
    passive:{ type:'bambooCharge', atkPct:100, selfHpPct:16, healSelfHpPct:5, hpGainAtkPct:25,
              desc:'每隔1回合充能，技能后追加穿透攻击(100%ATK+16%HP)={P:ATK+HP*0.16}，回复{H:HP*0.05}HP，永久+{H:ATK*0.25}最大HP' },
    skills:[
      { name:'一叶刃', type:'bambooLeaf', hits:3, power:0, pierce:0, cd:0, atkScale:0.2, selfHpPct:7,
        brief:'竹叶龟甩出3片叶刃，每段{N:0.2*ATK}+7%最大HP普通伤害',
        detail:'竹叶龟对单体甩出3片叶刃。\n每段造成 20%×(攻击力={ATK}) = {N:0.2*ATK} + 7%×(最大HP={HP}) = {N:HP*0.07} 普通伤害。\n共 {N:0.2*ATK*3+HP*0.07*3} 普通伤害。' },
      { name:'自然恢复', type:'bambooHeal', hits:1, power:0, pierce:0, cd:3, healPct:15, shieldPct:15, shieldTurns:3, soloHealPct:23,
        brief:'竹叶龟回复{H:HP*0.15}HP，队友获得{S:HP*0.15}护盾3回合（无队友则回复{H:HP*0.23}）',
        detail:'竹叶龟回复 15%×(最大HP={HP}) = {H:HP*0.15} HP。\n为存活队友施加 15%×(最大HP={HP}) = {S:HP*0.15} 护盾，持续3回合。\n如果没有存活队友，改为回复 23%×(最大HP={HP}) = {H:HP*0.23} HP。\n冷却{cd}回合。' },
    ]},
  // B级
  ...
  { id:'ice',       name:'寒冰龟',   emoji:'❄️🐢',    rarity:'B',   hp:340,  atk:38,  def:16, spd:9, crit:0.25,
  ...
  { id:'ninja',     name:'忍者龟',   emoji:'🥷🐢',    rarity:'B',   hp:310,  atk:46,  def:9,  spd:15, crit:0.25,
    ...
    skills:[
      { name:'飞镖',     type:'ninjaShuriken', hits:1, power:80, pierce:0, cd:0, atkScale:0,
        brief:'忍者龟投掷飞镖造成{N:80}普通伤害，暴击时转为穿透伤害',
        detail:'忍者龟对单体目标投掷飞镖，造成 80 普通伤害。\n暴击时，全部伤害转为 80×暴击倍率 穿透伤害（无视防御）。' },
  ...
  { id:'ghost',     name:'幽灵龟',   emoji:'👻🐢',    rarity:'B',   hp:280,  atk:42,  def:8,  spd:14, crit:0.25,
    ...
    skills:[
      { name:'幽魂触碰', type:'ghostTouch', hits:1, power:0, pierce:0, cd:0, normalScale:0.5, pierceScale:0.8,
        brief:'幽灵龟灵体攻击，{N:0.5*ATK}普伤+{P:0.8*ATK}穿透',
        detail:'幽灵龟用灵体触碰敌人。\n造成 50%×(攻击力={ATK}) = {N:0.5*ATK} 普通伤害 + 80%×(攻击力={ATK}) = {P:0.8*ATK} 穿透伤害。' },
      { name:'虚化', type:'ghostPhase', hits:1, power:0, pierce:0, cd:3, shieldScale:0.8, dodgePct:50, dodgeTurns:2,
        brief:'幽灵龟虚化，获得{dodgePct}%闪避{dodgeTurns}回合 + {S:0.8*ATK}护盾',
        detail:'幽灵龟身体虚化。\n获得 {dodgePct}% 闪避率，持续{dodgeTurns}回合。\n同时获得 80%×(攻击力={ATK}) = {S:0.8*ATK} 护盾。\n冷却{cd}回合。' },
      { name:'灵魂风暴', type:'ghostStorm', hits:5, power:0, pierce:0, cd:4, pierceScale:0.25, dotScale:0.1, dotTurns:3,
        brief:'幽灵龟释放5段灵魂冲击，共{P:0.25*ATK*5}穿透，附加{D:0.1*ATK}持续伤害{dotTurns}回合',
        detail:'幽灵龟释放灵魂风暴。\n每段造成 25%×(攻击力={ATK}) = {P:0.25*ATK} 纯穿透伤害 × 5段 = {P:0.25*ATK*5}。\n附加诅咒：每回合 10%×(攻击力={ATK}) = {D:0.1*ATK} 持续伤害，持续{dotTurns}回合。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'dice',      name:'骰子龟',   emoji:'🎲🐢',    rarity:'B',   hp:320,  atk:40,  def:11, spd:11, crit:0.25,
    ...
    passive:{ type:'gamblerBlood', maxCritAtLoss:30, maxCritGain:60, overflowMult:1.5,
              desc:'基于已损HP获得暴击率(损30%HP→+60%暴击)，溢出每1%→1.5%爆伤' },
    skills:[
      { name:'骰子攻击', type:'diceAttack', hits:3, power:0, pierce:0, cd:0, atkScale:1.0, critBonusMult:100,
        brief:'骰子龟掷3颗骰子，共{N:ATK}+暴击率×100普通伤害，每段可暴击',
        detail:'骰子龟对单体掷出3颗骰子。\n总伤害 = 100%×(攻击力={ATK}) = {N:ATK} + 100×暴击率。\n均分为3段，每段独立判定暴击。\n暴击率越高基础伤害越高。' },
      { name:'孤注一掷', type:'diceAllIn', hits:1, power:0, pierce:0, cd:3, atkScale:1.2, lifestealPct:10,
        brief:'骰子龟对每个敌人造成{P:1.2*ATK}穿透伤害，本次10%生命偷取',
        detail:'骰子龟拼命一搏，获得本次攻击10%生命偷取。\n对每个敌方造成 120%×(攻击力={ATK}) = {P:1.2*ATK} 穿透伤害。\n穿透伤害无视防御。吸血基于造成的总伤害。\n冷却{cd}回合。' },
      { name:'命运骰子', type:'diceFate', hits:0, power:0, pierce:0, cd:5, minCrit:40, maxCrit:140, duration:5,
        brief:'骰子龟获得随机40%~140%暴击率{duration}回合，溢出转爆伤',
        detail:'骰子龟掷出命运骰子。\n获得随机 40%~140% 暴击率提升，持续{duration}回合。\n暴击率超过100%的部分，每1%转为1.5%暴击伤害。\n冷却{cd}回合。' },
    ]},
  // A级
  ...
  { id:'pirate',    name:'海盗龟',   emoji:'🏴‍☠️🐢',  rarity:'A',   hp:350,  atk:39,  def:14, spd:11, crit:0.25,
    ...
    skills:[
      ...
      { name:'火炮齐射', type:'physical', hits:6, power:0, pierce:0, cd:4, aoe:true, atkScale:0.18, hpPct:1.7,
        brief:'海盗龟对全体敌方开炮6段，每段{N:0.18*ATK}+1.7%目标HP普通伤害',
        detail:'海盗龟对全体敌方开炮6段，每段造成 18%×(攻击力={ATK}) = {N:0.18*ATK} + 1.7%目标最大HP 普通伤害，共 108%×(攻击力={ATK}) = {N:0.18*ATK*6} + 10.2%目标最大HP 普通伤害。\n冷却{cd}回合。' },
      { name:'朗姆酒',   type:'heal', hits:1, power:0, heal:0, cd:3, hot:{hpPerTurn:43,turns:4}, defUp:{val:6,turns:3},
        brief:'海盗龟喝朗姆酒，持续回复43HP/回合共4回合，防御+6点3回合',
        detail:'海盗龟喝朗姆酒，持续回复 43HP/回合 4回合（可叠加），并提升防御 +6点 持续3回合。\n冷却{cd}回合。' },
    ]},
  { id:'candy',     name:'糖果龟',   emoji:'🍬🐢',    rarity:'A',   hp:340,  atk:38,  def:14, spd:11, crit:0.25,
    ...
    skills:[
      ...
      { name:'糖衣炮弹', type:'magic', hits:4, power:0, pierce:0, cd:4, atkScale:0.35, pierceScale:0.1, defDown:{pct:15,turns:2},
        brief:'糖果龟发射4段糖衣炮弹，每段{N:0.35*ATK}普通+{P:0.1*ATK}穿透，减防{defDown.pct}%',
        detail:'糖果龟对单体发射4段糖衣炮弹。\n每段造成 35%×(攻击力={ATK}) = {N:0.35*ATK} 普通 + 10%×(攻击力={ATK}) = {P:0.1*ATK} 穿透。\n共 {N:0.35*ATK*4} 普通 + {P:0.1*ATK*4} 穿透。\n附加减防{defDown.pct}%持续{defDown.turns}回合。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'lava',      name:'熔岩龟',   emoji:'🌋🐢',    rarity:'S',   hp:380,  atk:38,  def:18, spd:7, crit:0.25,
    ...
    skills:[
      ...
      { name:'岩浆护甲', type:'shield', hits:1, power:0, pierce:0, cd:3, shieldAtkScale:1.3,
        brief:'熔岩龟获得{S:1.3*ATK}护盾',
        detail:'熔岩龟获得 130%×(攻击力={ATK}) = {S:1.3*ATK} 护盾。\n冷却{cd}回合。' },
  ...
  { id:'crystal',   name:'水晶龟',   emoji:'🔮🐢',    rarity:'S',   hp:350,  atk:40,  def:21, spd:11, crit:0.25,
    ...
    skills:[
      ...
      { name:'水晶壁垒', type:'shield', hits:1, power:0, pierce:0, cd:3, shieldAtkScale:1.3,
        brief:'水晶龟获得{S:1.3*ATK}护盾',
        detail:'水晶龟获得 130%×(攻击力={ATK}) = {S:1.3*ATK} 护盾。\n冷却{cd}回合。' },
