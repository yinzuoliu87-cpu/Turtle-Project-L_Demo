...
const ALL_PETS = [
  ...
  { id:'chest',     name:'宝箱龟',   emoji:'📦🐢',    rarity:'S',   hp:345,  atk:40,  def:16, mr:14,crit:0.25,
    ...
    skillPool:[
      ...
      { name:'财宝风暴', type:'chestStorm', hits:5, power:0, pierce:0, cd:4, aoe:true, atkScale:0.25, pierceScale:0,
        brief:'宝箱龟对每个敌人飞射5段，共（{N:0.25*ATK*5}）物理伤害',
        detail:'宝箱龟对每个敌人飞射5段财宝。\n每段造成（25%×攻击力({ATK}) = {N:0.25*ATK}）物理伤害。\n共（{N:0.25*ATK*5}）物理伤害（每个敌人）。\n冷却{cd}回合。' },
