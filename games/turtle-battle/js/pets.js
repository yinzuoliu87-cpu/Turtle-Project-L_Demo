...
const ALL_PETS = [
  ...
  { id:'space',     name:'星际龟',   emoji:'🚀🐢',    rarity:'S',   hp:349,  atk:45,  def:13, mr:15, spd:17, crit:0.25,
    ...
    passive:{ type:'starEnergy', name:'星能', chargeRate:70, maxChargePct:40, passiveFirePct:40, burstPct:100,
              brief:'星际龟造成伤害积累星能。每次技能后额外打出 <span class="val-atk">40%</span> 星能真实伤害。满能时流星暴击消耗全部星能附加 <span class="val-atk">100%</span> 真实伤害',
              desc:'星际龟的星能核心。\n\n造成伤害的 <span class="val-atk">70%</span> 转化为星能，上限（40%×最大生命值({HP}) = {B:HP*0.4}）。\n\n每次释放技能后，额外打出相当于储存星能 <span class="val-atk">40%</span> 的真实伤害（对攻击目标）。\n\n流星暴击时，若星能已满，消耗全部星能，对全体敌人附加星能 <span class="val-atk">100%</span> 的真实伤害。' },
    skills:[
      ...
      { name:'虫洞', type:'starWormhole', hits:1, power:0, pierce:0, cd:4, pierceBonusPct:30, normalBonusPct:0, duration:4, magicPenAtkPct:10,
        brief:'星际龟标记敌人4回合：受到真实伤害 <span class="val-atk">+30%</span>。此外星际龟永久获得（{M:ATK*0.1}）魔法穿透',
