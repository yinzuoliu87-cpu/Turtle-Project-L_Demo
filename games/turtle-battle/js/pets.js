...
const ALL_PETS = [
  ...
  { id:'ice',       name:'寒冰龟',   emoji:'❄️🐢',    rarity:'B',   hp:370,  atk:38,  def:16, spd:9, crit:0.25,
    ...
    skills:[
      { name:'冰锥', type:'iceSpike', hits:6, power:0, pierce:0, cd:0, totalScale:1.2,
        brief:'寒冰龟发射6段冰锥，普通/穿透交替，共{N:1.2*ATK}混合伤害',
  ...
  { id:'two_head',  name:'双头龟',   emoji:'🐢🐢',    rarity:'B',   hp:293,  atk:49,  def:11, spd:7, crit:0.25,
    ...
    meleeSkills:[
      ...
      { name:'吸收', type:'twoHeadAbsorb', hits:1, power:0, pierce:0, cd:2, atkScale:0.5, hpPct:6, healLostPct:15,
        brief:'双头龟造成{N:0.5*ATK}+6%目标HP普通伤害，回复15%已损生命值',
  ...
  { id:'chest',     name:'宝箱龟',   emoji:'📦🐢',    rarity:'S',   hp:360,  atk:39,  def:15, spd:10, crit:0.25,
    ...
    skills:[
      { name:'宝箱砸击', type:'physical', hits:1, power:0, pierce:0, cd:0, atkScale:1.2, defDown:{pct:20,turns:2},
        brief:'宝箱龟砸击敌方，造成{N:1.2*ATK}普通伤害，减防{defDown.pct}%',
        detail:'宝箱龟对单体造成 120%×(攻击力={ATK}) = {N:1.2*ATK} 普通伤害。\n附加减防{defDown.pct}%持续{defDown.turns}回合。' },
      ...
      { name:'财宝风暴', type:'physical', hits:6, power:0, pierce:0, cd:4, atkScale:0.2, pierceScale:0.1, atkDown:{pct:15,turns:2},
        brief:'宝箱龟飞射6段财宝，每段{N:0.2*ATK}普通+{P:0.1*ATK}穿透，减攻{atkDown.pct}%',
        detail:'宝箱龟飞射6段财宝。\n每段造成 20%×ATK = {N:0.2*ATK} 普通 + 10%×ATK = {P:0.1*ATK} 穿透。\n共 {N:0.2*ATK*6} 普通 + {P:0.1*ATK*6} 穿透。\n附加减攻{atkDown.pct}%持续{atkDown.turns}回合。\n冷却{cd}回合。' },
    ]},
