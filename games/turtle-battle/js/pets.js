...
const ALL_PETS = [
  ...
  { id:'ghost',     name:'幽灵龟',   emoji:'👻🐢',    rarity:'B',   hp:290,  atk:42,  def:9,  spd:14, crit:0.25,
    ...
    skills:[
      { name:'幽魂触碰', type:'ghostTouch', hits:1, power:0, pierce:0, cd:0, normalScale:0.5, pierceScale:0.9,
        brief:'幽灵龟灵体攻击，{N:0.5*ATK}普伤+{P:0.9*ATK}穿透',
        detail:'幽灵龟用灵体触碰敌人。\n造成 50%×(攻击力={ATK}) = {N:0.5*ATK} 普通伤害 + 90%×(攻击力={ATK}) = {P:0.9*ATK} 穿透伤害。' },
