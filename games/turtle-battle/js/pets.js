...
const ALL_PETS = [
  ...
  { id:'hunter',    name:'猎人龟',   emoji:'🏹🐢',    rarity:'A',   hp:320,  atk:42,  def:12, spd:14, crit:0.25,
    ...
    skills:[
      ...
      { name:'连珠箭',   type:'hunterBarrage', hits:10, power:0, pierce:0, cd:3, arrowScale:0.2,
        brief:'猎人龟发射{hits}根箭随机射向敌方，每根{P:arrowScale*ATK}穿透，每段可暴击',
        detail:'猎人龟发射{hits}根箭，随机分布到敌方。\n每根造成 20%×(攻击力={ATK}) = {P:arrowScale*ATK} 穿透伤害，每根独立判定暴击。\n共 200%×(攻击力={ATK}) = {P:arrowScale*ATK*hits} 穿透伤害。\n冷却{cd}回合。' },
  ...
  { id:'bubble',    name:'泡泡龟',   emoji:'🫧🐢',    rarity:'A',   hp:320,  atk:37,  def:17, spd:13, crit:0.25,
    ...
    skills:[
      ...
      { name:'泡泡攻击', type:'magic', hits:3, power:0, pierce:0, cd:0, atkScale:0.65,
        brief:'泡泡龟攻击3段，共{N:0.65*ATK*3}普通伤害',
        detail:'每段造成 65%×(攻击力={ATK}) = {N:0.65*ATK} 普通伤害 × 3段 = {N:0.65*ATK*3}' },
