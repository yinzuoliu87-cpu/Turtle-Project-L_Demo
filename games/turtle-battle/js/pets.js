...
const ALL_PETS = [
  ...
  { id:'ghost',     name:'幽灵龟',   emoji:'👻🐢',    rarity:'B',   hp:319,  atk:43,  def:10, mr:10, spd:14, crit:0.25,
    ...
    skills:[
      { name:'幽魂触碰', type:'ghostTouch', hits:1, power:0, pierce:0, cd:0, normalScale:0.4, pierceScale:1.0,
        brief:'幽灵龟灵体攻击，造成（{N:0.4*ATK}）物理 +（{T:ATK}）真实伤害',
        detail:'幽灵龟用灵体触碰敌人。\n造成（40%×攻击力({ATK}) = {N:0.4*ATK}）物理伤害 +（100%×攻击力({ATK}) = {T:ATK}）真实伤害。' },
      ...
      { name:'灵魂风暴', type:'ghostStorm', dmgType:'true', hits:5, power:0, pierce:0, cd:5, pierceScale:0.38, dotTurns:3,
        brief:'幽灵龟对单体5段，共（{T:0.38*ATK*5}）真实伤害，施加诅咒3回合（每回合 <span class="val-true">9%</span> 目标最大生命值）',
        detail:'幽灵龟对单体释放灵魂风暴。\n每段造成（38%×攻击力({ATK}) = {T:0.38*ATK}）真实伤害。\n共（190%×攻击力({ATK}) = {T:0.38*ATK*5}）真实伤害。\n施加诅咒3回合：每回合 <span class="val-true">9%</span> 目标最大生命值真实伤害。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'fortune',   name:'财神龟',   emoji:'🧧🐢',    rarity:'B',   hp:350,  atk:39,  def:16, mr:16, spd:10, crit:0.25,
    ...
    skills:[
      ...
      { name:'骰子',     type:'fortuneDice', hits:1, power:0, pierce:0, cd:0, healPct:10, healLostPct:15, postAllInShieldPct:10,
  ...
  { id:'bubble',    name:'泡泡龟',   emoji:'🫧🐢',    rarity:'A',   hp:350,  atk:39,  def:18, mr:19, spd:14, crit:0.25,
    ...
    passive:{ type:'bubbleStore', name:'泡沫', pct:30, healPct:25, dmgPct:25,
              brief:'泡泡龟受伤储存 <span class="val-atk">30%</span> 为泡泡值，每回合消耗 <span class="val-heal">25%</span> 回复生命 + <span class="val-magic">25%</span> 打击随机敌人',
              desc:'泡泡龟受到的伤害储存 <span class="val-atk">30%</span> 为泡泡值。\n每回合消耗泡泡值的 <span class="val-heal">25%</span> 回复等量生命值。\n另外消耗泡泡值的 <span class="val-magic">25%</span> 作为魔法伤害打击随机敌人。' },
    skills:[
  ...
  { id:'lightning', name:'闪电龟',   emoji:'⚡🐢',    rarity:'A',   hp:329,  atk:46,  def:10, mr:13, spd:18, crit:0.25,
    ...
    passive:{ type:'lightningStorm', name:'雷电', shockScale:0.9, stackMax:8,
              brief:'闪电龟每回合电击随机敌人 {T:ATK*0.9} 真实伤害；攻击叠电击层，满8层引爆 {T:ATK*0.9} 真实伤害',
  ...
  { id:'lava',      name:'熔岩龟',   emoji:'🌋🐢',    rarity:'S',   hp:290,  atk:40,  def:14, mr:16, spd:8, crit:0.25,
    ...
    skills:[
      { name:'熔岩弹', type:'lavaBolt', dmgType:'magic', hits:1, power:0, pierce:0, cd:0, atkScale:1.0, targetHpPct:9, burn:true,
        brief:'熔岩龟造成（{M:1.0*ATK}）+ 9%目标最大生命值 魔法伤害 + <span style="color:#ff6600">灼烧</span>',
        detail:'熔岩龟对单体造成（100%×攻击力({ATK}) = {M:1.0*ATK}）+ 9%目标最大生命值 魔法伤害。\n施加<span style="color:#ff6600">灼烧</span>4回合。' },
      { name:'地裂', type:'lavaQuake', dmgType:'magic', hits:1, power:0, pierce:0, cd:3, aoe:true, atkScale:0.8, mrDown:{pct:20,turns:3},
        brief:'熔岩龟对全体敌方造成（{M:0.8*ATK}）魔法伤害，削减 <span class="val-atk">-20%</span> 魔抗3回合',
        detail:'熔岩龟对全体敌方造成（80%×攻击力({ATK}) = {M:0.8*ATK}）魔法伤害。\n削减全体敌方魔抗 <span class="val-atk">-20%</span>，持续3回合。\n冷却{cd}回合。' },
    ...
    volcanoSkills:[
      { name:'烈焰重击', type:'volcanoSmash', hits:1, power:0, pierce:0, cd:0, atkScale:1.4, selfHpPct:12, lifestealPct:35,
        brief:'火山龟造成（{N:1.4*ATK}）+12%自身最大生命值 物理伤害，回复伤害的 <span class="val-heal">35%</span>',
        detail:'火山龟对单体造成（140%×攻击力({ATK}) = {N:1.4*ATK}）+ 12%自身最大生命值 物理伤害。\n回复造成伤害的 <span class="val-heal">35%</span> 生命值。' },
      { name:'熔岩铠甲', type:'volcanoArmor', hits:1, power:0, pierce:0, cd:3, shieldAtkScale:1.2, defMrUpPct:25, defMrUpTurns:3, healLostPct:15,
        brief:'火山龟获得（{S:1.2*ATK}）护盾 + 护甲/魔抗 <span class="val-atk">+25%</span> 3回合 + 回复 <span class="val-heal">15%</span> 已损生命值',
        detail:'火山龟获得（120%×攻击力({ATK}) = {S:1.2*ATK}）护盾。\n提升护甲/魔抗 <span class="val-atk">+25%</span>，持续3回合。\n回复 <span class="val-heal">15%</span> 已损生命值。\n冷却{cd}回合。' },
      { name:'火山爆发', type:'volcanoErupt', dmgType:'magic', hits:5, power:0, pierce:0, cd:4, aoe:true, atkScale:0.28, pierceScale:0.14, selfHpPct:3, burn:true,
