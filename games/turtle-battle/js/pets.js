...
const ALL_PETS = [
  ...
  { id:'lightning', name:'闪电龟',   emoji:'⚡🐢',    rarity:'A',   hp:329,  atk:42,  def:10, mr:13, spd:18, crit:0.25,
    ...
    passive:{ type:'lightningStorm', name:'雷电', shockScale:0.8, stackMax:8,
              brief:'闪电龟每回合电击随机敌人 {T:ATK*0.8} 真实伤害；攻击叠电击层，满8层引爆 {T:ATK*0.8} 真实伤害',
              desc:'闪电龟周身环绕雷电之力。\n\n每回合自动电击随机敌人，造成（80%×攻击力({ATK}) = {T:ATK*0.8}）真实伤害。\n\n每段攻击命中敌人叠加1层电击标记，满{stackMax}层时引爆雷暴，\n造成（80%×攻击力({ATK}) = {T:ATK*0.8}）真实伤害并清零层数。' },
    skills:[
  ...
  { id:'phoenix',   name:'凤凰龟',   emoji:'🔥🐢',    rarity:'S',   hp:330,  atk:42,  def:12, mr:15, spd:14, crit:0.25,
    ...
    passive:{ type:'phoenixRebirth', name:'涅槃', revivePct:35,
    ...
    skills:[
      ...
      { name:'烫伤',   type:'phoenixScald', dmgType:'magic', hits:1, power:0, pierce:0, cd:5, atkScale:0.7, atkDown:{pct:15,turns:4}, defDown:{pct:15,turns:4}, mrDown:{pct:15,turns:4}, shieldBreak:55, burn:true, healReduce:true,
        brief:'凤凰龟破坏55%护盾，造成（{M:0.7*ATK}）魔法伤害，施加 <span class="val-atk">-15%</span> 攻击力/护甲/魔抗 + <span style="color:#ff6600">灼烧</span> + 治疗削减 4回合',
        detail:'凤凰龟对单体施放烫伤。\n先破坏目标 <span class="val-atk">55%</span> 的护盾值，再造成（70%×攻击力({ATK}) = {M:0.7*ATK}）魔法伤害。\n施加攻击力 <span class="val-atk">-15%</span>、护甲 <span class="val-atk">-15%</span>、魔抗 <span class="val-atk">-15%</span> 效果，持续4回合。\n施加<span style="color:#ff6600">灼烧</span>4回合和治疗削减4回合（<span class="val-atk">-50%</span>）。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'space',     name:'星际龟',   emoji:'🚀🐢',    rarity:'S',   hp:349,  atk:45,  def:13, mr:15, spd:17, crit:0.25,
    ...
    passive:{ type:'starEnergy', name:'星能', chargeRate:65, maxChargePct:40, passiveFirePct:30, burstPct:100,
