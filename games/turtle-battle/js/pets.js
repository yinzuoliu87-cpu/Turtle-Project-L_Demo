  ...
  { id:'gambler',   name:'赌神龟',   emoji:'🃏🐢',    rarity:'A',   hp:329,  atk:47,  def:11, mr:11, spd:14, crit:0.25,
    ...
    skills:[
      { name:'卡牌射击', type:'gamblerCards', hits:3, power:0, pierce:0, cd:0, minScale:0.3, maxScale:0.6,
        brief:'赌神龟射出3张牌，每段随机造成（{N:ATK*0.3}~{N:ATK*0.6}）物理伤害，每段可触发多重打击',
      ...
      { name:'抽牌',     type:'gamblerDraw', hits:1, power:0, pierce:0, cd:2,
        ...
        detail:'赌神龟随机抽一张牌：\n💚回复牌：回复 <span class="val-heal">10%</span> 最大生命值 + <span class="val-heal">5%</span> 最大生命值护盾\n💥炸弹牌：全体敌方造成（90%×攻击力({ATK}) = {N:ATK*0.9}）物理伤害\n⚡强化牌：攻击力 <span class="val-atk">+15%</span> + 暴击率 <span class="val-atk">+25%</span> + 爆伤 <span class="val-atk">+15%</span> + <span class="val-atk">20%</span> 伤害转真实，持续3回合\n冷却{cd}回合。' },
      { name:'赌注',     type:'gamblerBet', hits:6, power:0, pierce:0, cd:4, hpCostPct:50, multiBonus:20,
        brief:'赌神龟消耗 <span class="val-atk">50%</span> 当前HP，分为6段物理伤害打向目标，多重打击概率提升至 <span class="val-atk">60%</span>（需HP>50%）',
        detail:'赌神龟消耗当前 <span class="val-atk">50%</span> HP，将消耗的生命值分为6次打击，对单体目标造成物理伤害。\n每段可暴击，可触发多重打击被动。\n多重打击概率从 <span class="val-atk">40%</span> 提升至 <span class="val-atk">60%</span>。\n需HP>50%才能使用。\n冷却{cd}回合。' },
    ]},
