...
const ALL_PETS = [
  ...
  { id:'basic',     name:'小龟',     emoji:'🐢',      rarity:'C',   hp:350,  atk:40,  def:14, mr:13,crit:0.25,
    ...
    skillPool:[
      ...
      { name:'团队鼓舞', type:'commonAtkBuff', cd:4, hits:0, power:0, pierce:0, aoeAlly:true, selfCast:true, atkUpPct:20, atkUpTurns:3,
        brief:'全体友方攻击力 +20% 持续3回合', detail:'为全体友方施加攻击力 +20% 增益，持续3回合。\n冷却{cd}回合。' },
