  ...
  { id:'line',      name:'线条龟',   emoji:'✏️🐢',    rarity:'A',   hp:332,  atk:46,  def:10, mr:11, spd:16, crit:0.25,
    ...
    skills:[
      { name:'素描', type:'lineSketch', hits:3, power:0, pierce:0, cd:0, atkScale:0.35,
        brief:'线条龟画出3笔，每笔（{N:0.35*ATK}）物理伤害，共（{N:0.35*ATK*3}），每段叠1层墨迹',
        detail:'线条龟对单体快速画出3笔。\n每笔造成（35%×攻击力({ATK}) = {N:0.35*ATK}）物理伤害。\n共（105%×攻击力({ATK}) = {N:0.35*ATK*3}）物理伤害。\n每段命中叠加1层墨迹（使目标受到伤害 <span class="val-atk">+5%</span>/层，上限5层）。' },
      { name:'连笔', type:'lineLink', hits:1, power:0, pierce:0, cd:3, atkScale:0.5, duration:3, transferPct:30,
        brief:'线条龟连接2个敌人3回合，各造成（{N:0.5*ATK}）物理伤害+叠墨迹，伤害传递 <span class="val-atk">30%</span> 真实',
      ...
      { name:'画龙点睛', type:'lineFinish', hits:1, power:0, pierce:0, cd:4, baseScale:0.6, perStackScale:0.4,
        brief:'线条龟引爆目标墨迹：（{N:0.6*ATK}）物理 + 每层（{T:0.4*ATK}）真实，满层共（{N:0.6*ATK}）物理 +（{T:0.4*ATK*5}）真实',
        detail:'线条龟完成最后一笔，引爆目标所有墨迹。\n造成（60%×攻击力({ATK}) = {N:0.6*ATK}）物理伤害。\n每层墨迹额外造成（40%×攻击力({ATK}) = {T:0.4*ATK}）真实伤害。\n\n满5层引爆：（{N:0.6*ATK}）物理 +（{T:0.4*ATK*5}）真实 = 共（{N:0.6*ATK+0.4*ATK*5}）混合伤害。\n引爆后清除目标所有墨迹。\n冷却{cd}回合。' },
    ]},
