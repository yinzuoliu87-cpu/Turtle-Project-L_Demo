  ...
  { id:'two_head',  name:'双头龟',   emoji:'🐢🐢',    rarity:'B',   hp:302,  atk:50,  def:11, mr:12, spd:7, crit:0.25,
    ...
    skills:[
      ...
      { name:'灵能冲击', type:'physical', hits:1, power:0, pierce:0, cd:4, aoe:true, atkScale:0.85, hpPct:11,
        brief:'双头龟对全体敌方造成（{N:0.85*ATK}）+ 11%目标最大生命值 物理伤害',
        detail:'双头龟对全体敌方造成（85%×攻击力({ATK}) = {N:0.85*ATK}）+ 11%目标最大生命值 物理伤害。\n冷却{cd}回合。' },
      { name:'切换近战', type:'twoHeadSwitch', hits:1, power:0, pierce:0, cd:4, switchTo:'melee',
        brief:'切换近战：+{H:ATK*1.5}HP +{D:ATK*0.25}护甲 -{N:ATK*0.3}攻击力，获得{S:ATK*1.1}护盾',
        detail:'双头龟切换为近战形态。\n最大生命值增加（150%×攻击力({ATK}) = {H:ATK*1.5}）\n护甲增加（25%×攻击力({ATK}) = {D:ATK*0.25}）\n攻击力降低（30%×攻击力({ATK}) = {N:ATK*0.3}）\n获得（110%×攻击力({ATK}) = {S:ATK*1.1}）护盾\n冷却{cd}回合。' },
    ],
    // 近战技能组（切换后替换）
    meleeSkills:[
      ...
      { name:'吸收', type:'twoHeadAbsorb', hits:1, power:0, pierce:0, cd:2, atkScale:0.5, hpPct:6, healLostPct:16,
        brief:'双头龟造成（{N:0.5*ATK}）+ 6%目标最大生命值 物理伤害，回复 <span class="val-heal">16%</span> 已损生命值',
        detail:'双头龟对单体造成（50%×攻击力({ATK}) = {N:0.5*ATK}）+ 6%目标最大生命值 物理伤害。\n回复自身 <span class="val-heal">16%</span> 已损生命值。\n冷却{cd}回合。' },
      { name:'切换远程', type:'twoHeadSwitch', hits:1, power:0, pierce:0, cd:4, switchTo:'ranged', atkScale:1.4, defReductionScale:0.1, defReductionTurns:4,
        brief:'切换远程并造成（{N:ATK*1.4}）物理伤害，削减目标 <span class="val-atk">-{D:ATK*0.1}</span> 护甲4回合',
