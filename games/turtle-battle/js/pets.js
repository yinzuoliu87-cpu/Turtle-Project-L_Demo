...
const ALL_PETS = [
  ...
  { id:'ice',       name:'寒冰龟',   emoji:'❄️🐢',    rarity:'B',   hp:340,  atk:38,  def:14, spd:9, crit:0.25,
    ...
    skills:[
      ...
      { name:'冰盾', type:'shield', hits:1, power:0, pierce:0, shield:0, cd:3, shieldAtkScale:1.2,
        brief:'寒冰龟为友方施加{S:1.2*ATK}护盾',
        detail:'寒冰龟为友方单体施加 120%×(攻击力={ATK}) = {S:1.2*ATK} 护盾。\n冷却{cd}回合。' },
      { name:'冰霜', type:'iceFrost', hits:1, power:0, pierce:0, cd:4, atkScale:1.0,
        brief:'寒冰龟对全体敌方造成{P:1.0*ATK}穿透伤害',
        detail:'寒冰龟释放冰霜，对全体敌方造成 100%×(攻击力={ATK}) = {P:1.0*ATK} 穿透伤害。\n冷却{cd}回合。' },
    ]},
