...
const ALL_PETS = [
  ...
  { id:'space',     name:'星际龟',   emoji:'🚀🐢',    rarity:'S',   hp:349,  atk:48,  def:13, mr:15, spd:17, crit:0.25,
    ...
    passive:{ type:'starEnergy', name:'星能', chargeRate:100, maxChargePct:40, passiveFirePct:60, burstPct:100,
              brief:'星际龟造成伤害积累星能。每次技能后额外打出 <span class="val-atk">60%</span> 星能真实伤害。满能时流星暴击消耗全部星能附加 <span class="val-atk">100%</span> 真实伤害',
              desc:'星际龟的星能核心。\n\n造成伤害的 <span class="val-atk">100%</span> 转化为星能，上限（40%×最大生命值({HP}) = {B:HP*0.4}）。\n\n每次释放技能后，额外打出相当于储存星能 <span class="val-atk">60%</span> 的真实伤害（对攻击目标）。\n\n流星暴击时，若星能已满，消耗全部星能，对全体敌人附加星能 <span class="val-atk">100%</span> 的真实伤害。' },
    skills:[
      { name:'星光射线', type:'starBeam', dmgType:'magic', hits:3, power:0, pierce:0, cd:0, atkScale:0.4, currentHpPct:8,
        brief:'星际龟发射3段，共（{M:0.4*ATK*3}）+ 24%目标当前HP 魔法伤害',
        detail:'星际龟对单体发射3段。\n每段造成（40%×攻击力({ATK}) = {M:0.4*ATK}）+ 8%目标当前HP 魔法伤害。\n共（120%×攻击力({ATK}) = {M:0.4*ATK*3}）+ 24%目标当前HP 魔法伤害。' },
      { name:'虫洞', type:'starWormhole', hits:1, power:0, pierce:0, cd:4, pierceBonusPct:30, normalBonusPct:15, duration:4,
        brief:'星际龟标记敌人4回合：受到真实伤害 <span class="val-atk">+30%</span>，星际龟对其魔法伤害 <span class="val-atk">+15%</span>',
        detail:'星际龟对敌方单体施加虫洞标记4回合。\n被标记目标受到的所有真实伤害 <span class="val-atk">+30%</span>。\n星际龟对该目标的魔法伤害 <span class="val-atk">+15%</span>。\n冷却{cd}回合。' },
