...
const ALL_PETS = [
  ...
  { id:'bamboo',    name:'竹叶龟',   emoji:'🎋🐢',    rarity:'C',   hp:300,  atk:40,  def:10, spd:12, crit:0.25,
    ...
    passive:{ type:'bambooCharge', atkPct:95, selfHpPct:16, healSelfHpPct:8, hpGainAtkPct:30,
              desc:'每隔1回合充能🎋，充能回合技能释放后追加一发强化普攻：造成 {P:ATK*0.95+HP*0.16} 穿透伤害(95%ATK+16%最大HP)，回复 {H:HP*0.08} HP(8%最大HP)，并永久增加 {H:ATK*0.3} 最大生命值(30%ATK)' },
    skills:[
      { name:'一叶刃', type:'bambooLeaf', hits:3, power:0, pierce:0, cd:0, atkScale:0.22, selfHpPct:7,
        brief:'竹叶龟甩出3片叶刃，每段{N:0.22*ATK}+7%最大HP普通伤害',
        detail:'竹叶龟对单体甩出3片叶刃。\n每段造成 22%×(攻击力={ATK}) = {N:0.22*ATK} + 7%×(最大HP={HP}) = {N:HP*0.07} 普通伤害。\n共 {N:0.22*ATK*3+HP*0.07*3} 普通伤害。' },
      { name:'自然恢复', type:'bambooHeal', hits:1, power:0, pierce:0, cd:3, healPct:15, shieldPct:14, shieldTurns:3, soloHealPct:26,
        brief:'竹叶龟回复{H:HP*0.15}HP，队友获得{S:HP*0.14}护盾3回合（无队友则回复{H:HP*0.26}）',
        detail:'竹叶龟回复 15%×(最大HP={HP}) = {H:HP*0.15} HP。\n为存活队友施加 14%×(最大HP={HP}) = {S:HP*0.14} 护盾，持续3回合。\n如果没有存活队友，改为回复 26%×(最大HP={HP}) = {H:HP*0.26} HP。\n冷却{cd}回合。' },
    ]},
  // B级
  ...
  { id:'rainbow',   name:'彩虹龟',   emoji:'🌈🐢',    rarity:'A',   hp:340,  atk:40,  def:14, spd:12, crit:0.25,
    ...
    skills:[
      ...
      { name:'全色风暴', type:'magic', hits:7, power:0, pierce:0, cd:4, atkScale:0.2, defDown:{pct:20,turns:3}, phoenixBurn:{turns:3, atkPct:30, hpPct:5},
        brief:'彩虹龟释放7段风暴共{N:0.2*ATK*7}普伤，减防{defDown.pct}%{defDown.turns}回合，附加灼烧{phoenixBurn.turns}回合',
        detail:'彩虹龟释放七色风暴攻击单体。\n每段造成 20%×(攻击力={ATK}) = {N:0.2*ATK} 普通伤害 × 7段 = {N:0.2*ATK*7}。\n附加减防{defDown.pct}%持续{defDown.turns}回合。\n附加灼烧：每回合 30%×(攻击力={ATK}) + 5%最大HP 持续伤害，持续{phoenixBurn.turns}回合。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'candy',     name:'糖果龟',   emoji:'🍬🐢',    rarity:'A',   hp:340,  atk:38,  def:14, spd:11, crit:0.25,
    ...
    skills:[
      { name:'糖果弹', type:'magic', hits:2, power:0, pierce:0, cd:0, atkScale:0.5, atkDown:{pct:15,turns:2},
        brief:'糖果龟发射2颗糖果弹，共{N:0.5*ATK*2}普通伤害，减攻{atkDown.pct}%',
        detail:'糖果龟对单体发射2颗糖果弹。\n每段造成 50%×(攻击力={ATK}) = {N:0.5*ATK} 普通伤害，共{N:0.5*ATK*2}。\n附加减攻{atkDown.pct}%持续{atkDown.turns}回合。' },
      ...
      { name:'糖衣炮弹', type:'magic', hits:7, power:0, pierce:0, cd:4, atkScale:0.35, pierceScale:0.1, defDown:{pct:15,turns:2},
        brief:'糖果龟发射7段糖衣炮弹，每段{N:0.35*ATK}普通+{P:0.1*ATK}穿透，减防{defDown.pct}%',
        detail:'糖果龟对单体发射7段糖衣炮弹。\n每段造成 35%×(攻击力={ATK}) = {N:0.35*ATK} 普通 + 10%×(攻击力={ATK}) = {P:0.1*ATK} 穿透。\n共 {N:0.35*ATK*7} 普通 + {P:0.1*ATK*7} 穿透。\n附加减防{defDown.pct}%持续{defDown.turns}回合。\n冷却{cd}回合。' },
    ]},
