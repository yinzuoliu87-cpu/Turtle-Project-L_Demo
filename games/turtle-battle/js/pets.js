...
const ALL_PETS = [
  ...
  { id:'basic',     name:'小龟',     emoji:'🐢',      rarity:'C',   hp:320,  atk:40,  def:12, spd:10, crit:0.25,
    ...
    passive:{ type:'basicTurtle', bonusMap:{C:18,B:22,A:26,S:29,SS:32,SSS:34},
              desc:'攻击时按目标稀有度增伤：C+18% B+22% A+26% S+29% SS+32% SSS+34%' },
    skills:[
      { name:'攻击', type:'physical', hits:2, power:0, pierce:0, cd:0, atkScale:0.7, selfAtkUpPct:{pct:17, turns:2},
        brief:'小龟攻击2段，共{N:0.7*ATK*2}普通伤害，自身攻击+17% 2回合',
      ...
      { name:'打击', type:'basicBarrage', hits:10, power:0, pierce:0, cd:5, atkScale:2.7,
        brief:'小龟发射10段共{N:2.7*ATK}普通伤害随机分布敌方',
        detail:'小龟对敌方发射10段攻击，随机分布。\n共 270%×(攻击力={ATK}) = {N:2.7*ATK} 普通伤害。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'bubble',    name:'泡泡龟',   emoji:'🫧🐢',    rarity:'A',   hp:320,  atk:38,  def:15, spd:13, crit:0.25,
    img:'../../assets/pets/气泡龟v1.png', sprite:{frames:8,frameW:500,frameH:500,duration:800},
    passive:{ type:'bubbleStore', pct:50, healPct:80, desc:'受伤储存50%为泡泡值，每回合回复储存值80%' },
    skills:[
