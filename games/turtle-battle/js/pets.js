...
const ALL_PETS = [
  ...
  { id:'lava',      name:'熔岩龟',   emoji:'🌋🐢',    rarity:'S',   hp:290,  atk:40,  def:14, mr:16, spd:8, crit:0.25,
    ...
    skills:[
      ...
      { name:'地裂', type:'lavaQuake', dmgType:'magic', hits:1, power:0, pierce:0, cd:3, aoe:true, atkScale:0.7, mrDown:{pct:20,turns:3},
        brief:'熔岩龟对全体敌方造成（{M:0.7*ATK}）魔法伤害，削减 <span class="val-atk">-20%</span> 魔抗3回合',
        detail:'熔岩龟对全体敌方造成（70%×攻击力({ATK}) = {M:0.7*ATK}）魔法伤害。\n削减全体敌方魔抗 <span class="val-atk">-20%</span>，持续3回合。\n冷却{cd}回合。' },
    ...
    volcanoSkills:[
      ...
      { name:'火山爆发', type:'volcanoErupt', dmgType:'magic', hits:5, power:0, pierce:0, cd:4, aoe:true, atkScale:0.28, pierceScale:0.10, selfHpPct:3, burn:true,
