  ...
  { id:'bubble',    name:'泡泡龟',   emoji:'🫧🐢',    rarity:'A',   hp:350,  atk:39,  def:18, mr:19,crit:0.25,
    ...
    skillPool:[
      ...
      { name:'泡泡爆破', type:'bubbleBurst', dmgType:'magic', hits:1, power:0, pierce:0, cd:4, bubbleConsumePct:100, bubbleMagicScale:0.8, atkScale:0.8,
        brief:'泡泡龟消耗100%储存泡泡值，在目标所在一列两侧召唤2个泡泡夹击，对该列每个敌人造成（0.8×消耗值）魔法 +（{N:0.8*ATK}）物理',
        detail:'泡泡龟消耗当前所有储存泡泡值（100%），在目标所在一列（竖排）的两侧召唤2个泡泡向中间移动。\n对该列每个敌人造成：\n· 80% × 消耗的泡泡值 的<span class="val-magic">魔法伤害</span>\n· 80% × 攻击力({ATK}) = {N:0.8*ATK} 的<span class="val-direct">物理伤害</span>\n\n两个数字独立跳出（蓝魔 + 红物理）。\n冷却{cd}回合。' },
  ...
  { id:'cyber',     name:'赛博龟',   emoji:'🤖🐢',    rarity:'S',   hp:360,  atk:47,  def:14, mr:13,crit:0.25,
    ...
    skillPool:[
      ...
      { name:'能量大炮', type:'cyberBeam', hits:2, power:0, pierce:0, cd:3, atkScale:0.5, droneTrueScale:0.10, droneTrueScaleEnhanced:0.07,
        brief:'赛博龟向目标整行打出激光，每个敌人受2段共（{N:ATK}）物理 + 2段共（{T:0.10*ATK}）真实/浮游炮（强化后 {T:0.07*ATK}/炮台）',
