...
const ALL_PETS = [
  ...
  { id:'hunter',    name:'猎人龟',   emoji:'🏹🐢',    rarity:'A',   hp:339,  atk:43,  def:13, mr:11, spd:15, crit:0.25,
    ...
    skills:[
      ...
      { name:'连珠箭',   type:'hunterBarrage', dmgType:'true', hits:10, power:0, pierce:0, cd:4, arrowScale:0.23,
        brief:'猎人龟发射10根箭随机射向敌方，每根（{T:0.23*ATK}）真实伤害',
        detail:'猎人龟发射10根箭，随机分布到敌方目标。\n每根造成（23%×攻击力({ATK}) = {T:0.23*ATK}）真实伤害。\n共（230%×攻击力({ATK}) = {T:0.23*ATK*10}）真实伤害。\n冷却{cd}回合。' },
    ]},
