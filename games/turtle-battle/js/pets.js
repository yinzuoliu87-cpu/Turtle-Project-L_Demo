...
const ALL_PETS = [
  ...
  { id:'lava',      name:'熔岩龟',   emoji:'🌋🐢',    rarity:'S',   hp:290,  atk:40,  def:14, mr:16, spd:8, crit:0.25,
    ...
    volcanoSkills:[
      { name:'烈焰重击', type:'volcanoSmash', hits:1, power:0, pierce:0, cd:0, atkScale:1.4, selfHpPct:12, lifestealPct:25,
        brief:'火山龟造成（{N:1.4*ATK}）+12%自身最大生命值 物理伤害，回复伤害的 <span class="val-heal">25%</span>',
        detail:'火山龟对单体造成（140%×攻击力({ATK}) = {N:1.4*ATK}）+ 12%自身最大生命值 物理伤害。\n回复造成伤害的 <span class="val-heal">25%</span> 生命值。' },
      { name:'熔岩铠甲', type:'volcanoArmor', hits:1, power:0, pierce:0, cd:3, shieldAtkScale:0.9, defMrUpPct:25, defMrUpTurns:3, healLostPct:15,
        brief:'火山龟获得（{S:0.9*ATK}）护盾 + 护甲/魔抗 <span class="val-atk">+25%</span> 3回合 + 回复 <span class="val-heal">15%</span> 已损生命值',
