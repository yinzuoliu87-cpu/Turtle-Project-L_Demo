...
const ALL_PETS = [
  ...
  { id:'stone',     name:'石头龟',   emoji:'🪨🐢',    rarity:'C',   hp:380,  atk:35,  def:18, mr:15, spd:6, crit:0.25,
    ...
    passive:{ type:'stoneWall', name:'坚壁', defGain:2, maxDef:16, reflectBase:5, reflectPerDef:1, reflectPerMr:0.5,
              brief:'石头龟越战越硬。每回合永久 <span class="val-def">护甲</span><span class="val-atk">+2</span>（上限<span class="val-atk">+16</span>）；受伤反弹 (5% + 1%×<span class="val-def">护甲</span> + 0.5%×<span class="val-magic">魔抗</span>) 伤害',
