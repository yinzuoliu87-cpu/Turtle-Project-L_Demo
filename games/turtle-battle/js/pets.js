...
const ALL_PETS = [
  ...
  { id:'basic',     name:'小龟',     emoji:'🐢',      rarity:'C',   hp:320,  atk:39,  def:13, mr:11, spd:10, crit:0.25,
    ...
    skills:[
      { name:'攻击', type:'physical', hits:2, power:0, pierce:0, cd:0, atkScale:0.7, selfAtkUpPct:{pct:20, turns:2},
        brief:'小龟攻击2段，共{N:0.7*ATK*2}普通伤害，自身攻击+20% 2回合',
        detail:'小龟对单体打击2段，每段 70%×(攻击力={ATK}) = {N:0.7*ATK} 普通伤害，共 140%×(攻击力={ATK}) = {N:0.7*ATK*2}。\n自身攻击+20% 2回合。' },
      { name:'龟盾', type:'turtleShieldBash', hits:1, power:0, pierce:0, cd:2, atkScale:1.2, shieldFromDmgPct:80,
        brief:'小龟造成{N:1.2*ATK}普通伤害，获得80%伤害值的永久护盾',
        detail:'小龟对单体造成 120%×(攻击力={ATK}) = {N:1.2*ATK} 普通伤害。\n获得造成伤害80%的永久护盾。\n冷却{cd}回合。' },
      { name:'打击', type:'basicBarrage', hits:10, power:0, pierce:0, cd:5, atkScale:2.9,
        brief:'小龟发射10段共{N:2.9*ATK}普通伤害随机分布敌方',
        detail:'小龟对敌方发射10段攻击，随机分布。\n共 290%×(攻击力={ATK}) = {N:2.9*ATK} 普通伤害。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'bamboo',    name:'竹叶龟',   emoji:'🎋🐢',    rarity:'C',   hp:300,  atk:40,  def:10, mr:11, spd:12, crit:0.25,
    ...
    passive:{ type:'bambooCharge', atkPct:85, selfHpPct:10, healSelfHpPct:7, hpGainAtkPct:35,
              desc:'每隔1回合充能🎋，充能回合技能释放后追加一发强化普攻：造成 {P:ATK*0.85+HP*0.1} 穿透伤害(85%ATK+10%最大HP)，回复 {H:HP*0.07} HP(7%最大HP)，并永久增加 {H:ATK*0.35} 最大生命值(35%ATK)' },
    skills:[
      { name:'一叶刃', type:'bambooLeaf', hits:3, power:0, pierce:0, cd:0, atkScale:0.21, selfHpPct:6,
        brief:'竹叶龟甩出3片叶刃，每段{N:0.21*ATK}+6%最大HP普通伤害',
        detail:'竹叶龟对单体甩出3片叶刃。\n每段造成 21%×(攻击力={ATK}) = {N:0.21*ATK} + 6%×(最大HP={HP}) = {N:HP*0.06} 普通伤害。\n共 {N:0.21*ATK*3+HP*0.06*3} 普通伤害。' },
  ...
  { id:'angel',     name:'天使龟',   emoji:'😇🐢',    rarity:'B',   hp:330,  atk:40,  def:13, mr:16, spd:11, crit:0.25,
    ...
    skills:[
      ...
      { name:'平等', type:'angelEquality', dmgType:'magic', hits:2, power:0, pierce:0, cd:5, normalScale:0.6, pierceScale:0.6,
        ...
        brief:'天使龟造成{N:0.6*ATK}普通+{P:0.6*ATK}穿透，S级以上必暴击并回复总伤10%HP',
        detail:'天使龟对单体造成 60%×(攻击力={ATK}) = {N:0.6*ATK} 普通伤害 + 60%×(攻击力={ATK}) = {P:0.6*ATK} 穿透伤害。\n如果目标为S级或以上：必定暴击，回复总伤害的10%HP。\n冷却{cd}回合。' },
    ]},
  { id:'ice',       name:'寒冰龟',   emoji:'❄️🐢',    rarity:'B',   hp:370,  atk:38,  def:16, mr:17, spd:9, crit:0.25,
    ...
    skills:[
      { name:'冰锥', type:'iceSpike', hits:6, power:0, pierce:0, cd:0, totalScale:1.4,
        brief:'寒冰龟发射6段冰锥，普通/穿透交替，共{N:1.4*ATK}混合伤害',
        detail:'寒冰龟对单体发射6段冰锥，奇数段造成普通伤害，偶数段造成穿透伤害。\n共 140%×(攻击力={ATK}) = {N:1.4*ATK} 混合伤害。' },
      ...
      { name:'冰霜', type:'iceFrost', dmgType:'true', hits:1, power:0, pierce:0, cd:4, atkScale:1.2,
        brief:'寒冰龟对全体敌方造成{P:1.2*ATK}穿透伤害',
        detail:'寒冰龟释放冰霜，对全体敌方造成 120%×(攻击力={ATK}) = {P:1.2*ATK} 穿透伤害。\n冷却{cd}回合。' },
    ]},
  { id:'ninja',     name:'忍者龟',   emoji:'🥷🐢',    rarity:'B',   hp:310,  atk:46,  def:9,  mr:7, spd:15, crit:0.25,
    ...
    skills:[
      ...
      { name:'炸弹',     type:'ninjaBomb', hits:1, power:0, pierce:0, cd:4, atkScale:1.1, armorBreak:{pct:25,turns:3},
        brief:'忍者龟对全体敌方造成{N:atkScale*ATK}普通伤害，施加25%破甲3回合',
        detail:'忍者龟对全体敌方造成 110%×(攻击力={ATK}) = {N:atkScale*ATK} 普通伤害。\n施加 25% 破甲（防御削减）3回合。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'ghost',     name:'幽灵龟',   emoji:'👻🐢',    rarity:'B',   hp:300,  atk:42,  def:9,  mr:11, spd:14, crit:0.25,
    ...
    skills:[
      { name:'幽魂触碰', type:'ghostTouch', hits:1, power:0, pierce:0, cd:0, normalScale:0.5, pierceScale:1.0,
        ...
        detail:'幽灵龟用灵体触碰敌人。\n造成 50%×(攻击力={ATK}) = {N:0.5*ATK} 普通伤害\n+ 100%×(攻击力={ATK}) = {P:ATK} 穿透伤害。' },
      ...
      { name:'灵魂风暴', type:'ghostStorm', dmgType:'true', hits:5, power:0, pierce:0, cd:4, pierceScale:0.35, dotScale:0.1, dotTurns:3,
        brief:'对单体5段穿透共{P:0.35*ATK*5}，附加诅咒3回合（每回合{D:0.1*ATK}）',
        detail:'幽灵龟对单体目标释放灵魂风暴。\n每段造成 {P:0.35*ATK} 纯穿透伤害（35%攻击力）。\n5段共 {P:0.35*ATK*5} 穿透伤害。\n附加诅咒3回合：每回合 {D:0.1*ATK} 持续伤害（10%攻击力）。\n冷却{cd}回合。' },
    ]},
  { id:'diamond',   name:'钻石龟',   emoji:'💎🐢',    rarity:'B',   hp:350,  atk:35,  def:20, mr:17, spd:8, crit:0.25,
    ...
    passive:{ type:'diamondStructure', defBuffAmp:50, flatReductionPct:15,
              desc:'所有防御加成（自己和友军）额外+{defBuffAmp}%；每段受伤减少 15%×(防御={DEF}) = {N:DEF*0.15} 固定值（穿透除外）' },
    skills:[
      { name:'钻石切割', type:'physical', hits:1, power:0, pierce:0, cd:0, atkScale:0.7, defScale:1.2,
        brief:'钻石龟切割敌方，造成{N:0.7*ATK}+{N:1.2*DEF}普通伤害',
        detail:'钻石龟对单体造成 70%×(攻击力={ATK}) = {N:0.7*ATK} + 120%×(防御={DEF}) = {N:1.2*DEF} 普通伤害。\n防御越高伤害越高。' },
      ...
      { name:'碰撞', type:'diamondCollide', hits:1, power:0, pierce:0, cd:3, atkScale:0.8, defScale:2.1, selfHpPct:12, stunAfter:2,
        brief:'钻石龟撞击敌方，造成{N:0.8*ATK}+{N:2.1*DEF}+{N:HP*0.12}普通伤害，被撞2次眩晕1回合',
        detail:'钻石龟全身撞击单体，造成 80%×(攻击力={ATK}) = {N:0.8*ATK} + 210%×(防御={DEF}) = {N:2.1*DEF} + 12%×(最大HP={HP}) = {N:HP*0.12} 普通伤害。\n同一目标累计被碰撞{stunAfter}次→眩晕1回合（跳过行动，被动仍生效）。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'dice',      name:'骰子龟',   emoji:'🎲🐢',    rarity:'B',   hp:320,  atk:40,  def:11, mr:10, spd:11, crit:0.25,
    ...
    skills:[
      { name:'骰子攻击', type:'diceAttack', hits:3, power:0, pierce:0, cd:0, atkScale:0.9, critBonusMult:55,
        brief:'骰子龟掷3颗骰子，共{N:0.9*ATK+crit*55}普通伤害，每段可暴击',
        detail:'骰子龟对单体掷出3颗骰子。\n总伤害 = 90%×(攻击力={ATK}) = {N:0.9*ATK} + 55×(暴击率={N:crit*100}%) = {N:0.9*ATK+crit*55} 普通伤害。\n均分为3段，每段独立判定暴击。\n暴击率越高基础伤害越高。' },
  ...
  { id:'rainbow',   name:'彩虹龟',   emoji:'🌈🐢',    rarity:'A',   hp:340,  atk:40,  def:14, mr:16, spd:12, crit:0.25,
    ...
    skills:[
      { name:'七彩光束', type:'magic', dmgType:'magic', hits:2, power:0, pierce:0, cd:0, atkScale:0.7,
        brief:'彩虹龟射出光束2段，每段{N:0.7*ATK}普通伤害',
        detail:'彩虹龟射出七彩光束。\n每段造成 70%×(攻击力={ATK}) = {N:0.7*ATK} 普通伤害，共 140%×(攻击力={ATK}) = {N:0.7*ATK*2} 普通伤害。' },
      ...
      { name:'全色风暴', type:'magic', dmgType:'magic', hits:4, power:0, pierce:0, cd:4, aoe:true, atkScale:0.2, pierceScale:0.1, defDown:{pct:20,turns:3}, burn:true,
        brief:'彩虹龟对全体敌人释放4段风暴，每段{N:0.2*ATK}普通+{P:0.1*ATK}穿透，减防20%+灼烧3回合',
        detail:'彩虹龟对全体敌人释放七色风暴。\n每段造成 20%×(攻击力={ATK}) = {N:0.2*ATK} 普通 + 10%×ATK = {P:0.1*ATK} 穿透 × 4段。\n附加减防20%持续3回合。\n附加灼烧3回合（每回合30%ATK+5%最大HP）。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'hunter',    name:'猎人龟',   emoji:'🏹🐢',    rarity:'A',   hp:320,  atk:41,  def:12, mr:10, spd:14, crit:0.25,
    ...
    skills:[
      { name:'射箭',     type:'hunterShot', hits:3, power:0, pierce:0, cd:0, atkScale:0.5, execThresh:40, execCrit:40, execCritDmg:20,
        ...
        detail:'猎人龟对单体目标射击3段，每段造成 50%×(攻击力={ATK}) = {N:0.5*ATK} 普通伤害，共 150%×(攻击力={ATK}) = {N:0.5*ATK*3} 普通伤害。\n如果目标HP低于{execThresh}%，则{hits}次攻击获得 {B:execCrit}% 额外暴击率和 {B:execCritDmg}% 额外爆伤。' },
      { name:'连珠箭',   type:'hunterBarrage', dmgType:'true', hits:10, power:0, pierce:0, cd:3, arrowScale:0.16,
        brief:'猎人龟发射{hits}根箭随机射向敌方，每根{P:arrowScale*ATK}穿透，每段可暴击',
        detail:'猎人龟发射{hits}根箭，随机分布到敌方。\n每根造成 16%×(攻击力={ATK}) = {P:arrowScale*ATK} 穿透伤害，每根独立判定暴击。\n共 160%×(攻击力={ATK}) = {P:arrowScale*ATK*hits} 穿透伤害。\n冷却{cd}回合。' },
  ...
  { id:'pirate',    name:'海盗龟',   emoji:'🏴‍☠️🐢',  rarity:'A',   hp:350,  atk:39,  def:14, mr:12, spd:11, crit:0.25,
    ...
    passive:{ type:'pirateBarrage', bombardPct:25, deathHookPct:25,
              desc:'开局轰击随机敌人 25%×(最大HP={HP}) = {P:HP*0.25} 穿透；死亡时钩锁击杀者 {P:HP*0.25} 穿透' },
    skills:[
      { name:'弯刀',     type:'physical', hits:4, power:0, pierce:0, cd:0, atkScale:0.35,
        brief:'海盗龟打击4段，共{N:0.35*ATK*4}普通伤害',
        detail:'海盗龟对单体目标打击4段，每段造成 35%×(攻击力={ATK}) = {N:0.35*ATK} 普通伤害，共 140%×(攻击力={ATK}) = {N:0.35*ATK*4} 普通伤害。' },
      { name:'火炮齐射', type:'physical', hits:6, power:0, pierce:0, cd:4, aoe:true, atkScale:0.17, hpPct:1.7,
        brief:'海盗龟对全体敌方开炮6段，每段{N:0.17*ATK}+1.7%目标HP普通伤害',
        detail:'海盗龟对全体敌方开炮6段，每段造成 17%×(攻击力={ATK}) = {N:0.17*ATK} + 1.7%目标最大HP 普通伤害，共 102%×(攻击力={ATK}) = {N:0.17*ATK*6} + 10.2%目标最大HP 普通伤害。\n冷却{cd}回合。' },
  ...
  { id:'candy',     name:'糖果龟',   emoji:'🍬🐢',    rarity:'A',   hp:340,  atk:38,  def:14, mr:15, spd:11, crit:0.25,
    ...
    skills:[
      { name:'糖果弹', type:'magic', dmgType:'magic', hits:3, power:0, pierce:0, cd:0, atkScale:0.5, atkDown:{pct:15,turns:2},
        brief:'糖果龟发射3颗糖果弹，共{N:0.5*ATK*3}普通伤害，减攻15%',
        detail:'糖果龟对单体发射3颗糖果弹。\n每段造成 50%×(攻击力={ATK}) = {N:0.5*ATK} 普通伤害，共{N:0.5*ATK*3}。\n附加减攻15%持续2回合。' },
      ...
      { name:'糖衣炮弹', type:'magic', dmgType:'magic', hits:8, power:0, pierce:0, cd:4, atkScale:0.35, pierceScale:0.1, defDown:{pct:15,turns:2},
        brief:'糖果龟发射8段糖衣炮弹，每段{N:0.35*ATK}普通+{P:0.1*ATK}穿透，减防15%',
        detail:'糖果龟对单体发射8段糖衣炮弹。\n每段造成 35%×(攻击力={ATK}) = {N:0.35*ATK} 普通 + 10%×(攻击力={ATK}) = {P:0.1*ATK} 穿透。\n共 {N:0.35*ATK*8} 普通 + {P:0.1*ATK*8} 穿透。\n附加减防15%持续2回合。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'line',      name:'线条龟',   emoji:'✏️🐢',    rarity:'A',   hp:300,  atk:44,  def:9,  mr:10, spd:15, crit:0.25,
    ...
    skills:[
      { name:'素描', type:'lineSketch', hits:3, power:0, pierce:0, cd:0, atkScale:0.35,
        brief:'线条龟画出{hits}笔，每笔{N:0.35*ATK}普通伤害，每段叠1层墨迹',
        detail:'线条龟对单体快速画出{hits}笔。\n每笔造成 35%×(攻击力={ATK}) = {N:0.35*ATK} 普通伤害，共 105%×(攻击力={ATK}) = {N:0.35*ATK*3} 普通伤害。\n每段命中叠加1层墨迹（墨迹使目标受到伤害+5%/层，上限5层）。' },
      { name:'连笔', type:'lineLink', hits:1, power:0, pierce:0, cd:3, atkScale:0.5, duration:3, transferPct:30,
        brief:'线条龟连接2个敌人{duration}回合，伤害传递{transferPct}%穿透，墨迹共享',
        detail:'线条龟画线连接两个敌人，持续{duration}回合。\n对两个目标各造成 50%×(攻击力={ATK}) = {N:0.5*ATK} 普通伤害，各叠1层墨迹。\n连接期间，一方受到伤害的 {transferPct}% 以穿透伤害传递给另一方。\n一方获得墨迹时，另一方也获得相同层数。\n冷却{cd}回合。' },
      { name:'画龙点睛', type:'lineFinish', hits:1, power:0, pierce:0, cd:4, baseScale:0.6, perStackScale:0.4,
        brief:'线条龟引爆目标墨迹，基础{N:0.6*ATK}普伤 + 每层墨迹{P:0.4*ATK}穿透',
        detail:'线条龟完成最后一笔，引爆目标所有墨迹。\n基础造成 60%×(攻击力={ATK}) = {N:0.6*ATK} 普通伤害。\n每层墨迹额外造成 40%×(攻击力={ATK}) = {P:0.4*ATK} 穿透伤害。\n满5层引爆：{N:0.6*ATK} 普通 + {P:0.4*ATK*5} 穿透。\n引爆后清除目标所有墨迹。\n冷却{cd}回合。' },
    ]},
  { id:'lightning', name:'闪电龟',   emoji:'⚡🐢',    rarity:'A',   hp:310,  atk:43,  def:9,  mr:12, spd:17, crit:0.25,
    img:'../../assets/pets/闪电龟.png',
    passive:{ type:'lightningStorm', shockScale:0.9, stackMax:8, desc:'每回合电击随机敌人 90%×(攻击力={ATK}) = {P:ATK*0.9} 穿透；造成伤害叠电击层，满8层触发 {P:ATK*0.9} 穿透' },
    skills:[
      { name:'闪电打击', type:'lightningStrike', dmgType:'magic', hits:5, power:0, pierce:0, cd:0, atkScale:0.23, splashPct:25,
        brief:'闪电龟打击5段，共{N:0.23*ATK*5}普通伤害，每段溅射{splashPct}%到次目标',
        detail:'闪电龟对单体目标打击5段，每段造成 23%×(攻击力={ATK}) = {N:0.23*ATK} 普通伤害，共 115%×(攻击力={ATK}) = {N:0.23*ATK*5} 普通伤害。\n每段对次目标造成主目标 {splashPct}% 溅射伤害。每段命中叠1层电击。' },
      ...
      { name:'雷暴',     type:'lightningBarrage', dmgType:'magic', hits:20, power:0, pierce:0, cd:5, arrowScale:0.11,
        ...
        detail:'释放{hits}次闪电，随机分布到敌方。\n每次造成 11%×(攻击力={ATK}) = {N:arrowScale*ATK} 普通伤害。每次命中叠1层电击。\n冷却{cd}回合。' },
    ]},
  // S级
  { id:'phoenix',   name:'凤凰龟',   emoji:'🔥🐢',    rarity:'S',   hp:340,  atk:42,  def:14, mr:16, spd:13, crit:0.25,
    ...
    skills:[
      { name:'灼烧',   type:'phoenixBurn', dmgType:'magic', hits:1, power:0, pierce:0, cd:0, atkScale:0.9, burn:true,
        brief:'凤凰龟造成{N:atkScale*ATK}普通伤害，施加灼烧4回合（每回合30%ATK+3HP魔法伤害）',
  ...
  { id:'lava',      name:'熔岩龟',   emoji:'🌋🐢',    rarity:'S',   hp:380,  atk:38,  def:18, mr:16, spd:7, crit:0.25,
    ...
    skills:[
      { name:'熔岩喷发', type:'magic', dmgType:'magic', hits:1, power:0, pierce:0, cd:0, atkScale:0.9, burn:true,
        brief:'熔岩龟造成{N:0.9*ATK}普通伤害，施加灼烧3回合',
        detail:'熔岩龟对单体造成 90%×(攻击力={ATK}) = {N:0.9*ATK} 普通伤害。\n施加灼烧3回合，每回合造成 25%×ATK + 3%最大HP 伤害。' },
      ...
      { name:'火山爆发', type:'magic', dmgType:'magic', hits:5, power:0, pierce:0, cd:4, aoe:true, atkScale:0.14, pierceScale:0.07, burn:true,
        brief:'熔岩龟对全体敌方每人喷发5段，每段{N:0.14*ATK}普通+{P:0.07*ATK}穿透，施加灼烧3回合',
        detail:'熔岩龟对全体敌方每人喷发5段。\n每段造成 14%×(攻击力={ATK}) = {N:0.14*ATK} 普通 + 7%×ATK = {P:0.07*ATK} 穿透。\n施加灼烧3回合（每回合15%ATK+3%HP）。\n冷却{cd}回合。' },
    ]},
  { id:'cyber',     name:'赛博龟',   emoji:'🤖🐢',    rarity:'S',   hp:330,  atk:43,  def:13, mr:12, spd:15, crit:0.25,
    ...
    skills:[
      ...
      { name:'部署', type:'cyberDeploy', hits:1, power:0, pierce:0, cd:2,
        brief:'赛博龟立即部署1个浮游炮（每回合{N:ATK*0.13}普通伤害，上限10）',
        detail:'赛博龟立即生成1个浮游炮。\n每个浮游炮每回合对随机敌人造成 13%×(攻击力={ATK}) = {N:ATK*0.13} 普通伤害。\n最多持有10个。冷却2回合。' },
    ]},
  { id:'crystal',   name:'水晶龟',   emoji:'🔮🐢',    rarity:'S',   hp:350,  atk:40,  def:19, mr:21, spd:11, crit:0.25,
    ...
    skills:[
      { name:'水晶刺', type:'magic', dmgType:'magic', hits:2, power:0, pierce:0, cd:0, atkScale:0.5, pierceScale:0.15,
        brief:'水晶龟刺出2段，每段{N:0.5*ATK}普通+{P:0.15*ATK}穿透',
        detail:'水晶龟对单体刺出2段。\n每段造成 50%×(攻击力={ATK}) = {N:0.5*ATK} 普通 + 15%×ATK = {P:0.15*ATK} 穿透。\n共 {N:0.5*ATK*2} 普通 + {P:0.15*ATK*2} 穿透。' },
      ...
      { name:'碎晶风暴', type:'magic', dmgType:'magic', hits:7, power:0, pierce:0, cd:4, atkScale:0.16, pierceScale:0.09, burn:true,
        brief:'水晶龟释放7段碎晶，每段{N:0.16*ATK}普通+{P:0.09*ATK}穿透，附加灼烧3回合',
        detail:'水晶龟释放7段碎晶风暴。\n每段造成 16%×ATK = {N:0.16*ATK} 普通 + 9%×ATK = {P:0.09*ATK} 穿透。\n共 {N:0.16*ATK*7} 普通 + {P:0.09*ATK*7} 穿透。\n附加灼烧3回合（每回合15%ATK+3%HP）。\n冷却{cd}回合。' },
    ]},
  { id:'chest',     name:'宝箱龟',   emoji:'📦🐢',    rarity:'S',   hp:360,  atk:39,  def:19, mr:18, spd:10, crit:0.25,
    ...
    skills:[
      { name:'宝箱砸击', type:'physical', hits:1, power:0, pierce:0, cd:0, atkScale:1.4, defDown:{pct:20,turns:2},
        brief:'宝箱龟砸击敌方，造成{N:1.4*ATK}普通伤害，减防{defDown.pct}%',
        detail:'宝箱龟对单体造成 140%×(攻击力={ATK}) = {N:1.4*ATK} 普通伤害。\n附加减防{defDown.pct}%持续{defDown.turns}回合。' },
      ...
      { name:'财宝风暴', type:'physical', hits:6, power:0, pierce:0, cd:4, atkScale:0.22, pierceScale:0.13, atkDown:{pct:15,turns:2},
        brief:'宝箱龟飞射6段财宝，每段{N:0.22*ATK}普通+{P:0.13*ATK}穿透，减攻{atkDown.pct}%',
        detail:'宝箱龟飞射6段财宝。\n每段造成 22%×ATK = {N:0.22*ATK} 普通 + 13%×ATK = {P:0.13*ATK} 穿透。\n共 {N:0.22*ATK*6} 普通 + {P:0.13*ATK*6} 穿透。\n附加减攻{atkDown.pct}%持续{atkDown.turns}回合。\n冷却{cd}回合。' },
    ]},
  { id:'space',     name:'星际龟',   emoji:'🚀🐢',    rarity:'S',   hp:320,  atk:44,  def:12, mr:14, spd:16, crit:0.25,
    ...
    passive:{ type:'starEnergy', chargeRate:80, maxChargePct:50,
              desc:'造成伤害积累星能（伤害的80%），上限 {B:HP*0.5}（50%最大HP），满能时下次攻击附加等量{P:穿透爆发}' },
    skills:[
      { name:'星光射线', type:'starBeam', dmgType:'magic', hits:3, power:0, pierce:0, cd:0, atkScale:0.4, currentHpPct:5,
        ...
        detail:'星际龟对单体发射3段，每段 40%×(攻击力={ATK}) = {N:0.4*ATK} + 5%目标当前HP 普通伤害。\n共 120%×(攻击力={ATK}) = {N:0.4*ATK*3} + 15%目标当前HP。\n每段伤害的20%转为星能。' },
  ...
  { id:'headless',  name:'无头龟',   emoji:'💀🐢',    rarity:'SS',  hp:340,  atk:46,  def:10, mr:8, spd:14, crit:0.25,
    ...
    skills:[
      { name:'撕咬',   type:'physical', hits:2, power:0, pierce:0, cd:0, atkScale:0.5, hpPct:6,
        brief:'无头龟撕咬2段，共{N:0.5*ATK*2}普通伤害+{hpPct}%×2目标最大HP',
        detail:'每段造成 50%×(攻击力={ATK}) = {N:0.5*ATK} + {hpPct}%目标最大HP 普通伤害 × 2段' },
  ...
  { id:'shell',     name:'龟壳',     emoji:'🐚',      rarity:'SSS', hp:360,  atk:42,  def:18, mr:18, spd:12, crit:0.25,
    ...
    skills:[
      { name:'攻击', type:'shellStrike', hits:6, power:0, pierce:0, cd:0, totalScale:1.2, splashPct:25,
        brief:'龟壳打击6段普通/穿透交替，共{N:1.2*ATK}混合伤害，每段溅射{splashPct}%',
        detail:'龟壳对单体打击6段，奇数段普通伤害，偶数段穿透伤害。\n共 120%×(攻击力={ATK}) = {N:1.2*ATK} 混合伤害。\n每段对次目标溅射主目标{splashPct}%伤害。' },
