...
const ALL_PETS = [
  ...
  { id:'space',     name:'星际龟',   emoji:'🚀🐢',    rarity:'S',   hp:349,  atk:48,  def:13, mr:15, spd:17, crit:0.25,
    ...
    passive:{ type:'starEnergy', name:'星能', chargeRate:80, maxChargePct:60, passiveFirePct:40, burstPct:80,
              brief:'星际龟造成伤害积累星能。每次技能后额外打出 <span class="val-atk">40%</span> 星能真实伤害。满能时流星暴击消耗全部星能附加 <span class="val-atk">80%</span> 真实伤害',
              desc:'星际龟的星能核心。\n\n造成伤害的 <span class="val-atk">80%</span> 转化为星能，上限（60%×最大生命值({HP}) = {B:HP*0.6}）。\n\n每次释放技能后，额外打出相当于储存星能 <span class="val-atk">40%</span> 的真实伤害（对攻击目标）。\n\n流星暴击时，若星能已满，消耗全部星能，对全体敌人附加星能 <span class="val-atk">80%</span> 的真实伤害。' },
    skills:[
      ...
      { name:'虫洞', type:'starWormhole', hits:1, power:0, pierce:0, cd:3, pierceBonusPct:30, normalBonusPct:15, duration:3,
        brief:'星际龟标记敌人3回合：受到真实伤害 <span class="val-atk">+30%</span>，星际龟对其魔法伤害 <span class="val-atk">+15%</span>',
        detail:'星际龟对敌方单体施加虫洞标记3回合。\n被标记目标受到的所有真实伤害 <span class="val-atk">+30%</span>。\n星际龟对该目标的魔法伤害 <span class="val-atk">+15%</span>。\n冷却{cd}回合。' },
      { name:'流星暴击', type:'starMeteor', dmgType:'magic', hits:1, power:0, pierce:0, cd:2, atkScale:1.0, aoe:true, mrDown:{pct:20,turns:3},
        brief:'星际龟对全体敌方造成（{M:ATK}）魔法伤害。满能时消耗全部星能附加 <span class="val-atk">80%</span> 真实伤害。施加 <span class="val-atk">-20%</span> 魔抗3回合',
        detail:'星际龟对全体敌方造成（100%×攻击力({ATK}) = {M:ATK}）魔法伤害。\n若星能已满，消耗全部星能，对全体敌人附加星能 <span class="val-atk">80%</span> 的真实伤害。\n施加魔抗 <span class="val-atk">-20%</span> 效果，持续3回合。\n冷却{cd}回合。' },
    ]},
  // SS级
