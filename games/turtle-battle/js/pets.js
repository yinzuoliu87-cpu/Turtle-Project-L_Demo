...
const ALL_PETS = [
  ...
  { id:'lava',      name:'熔岩龟',   emoji:'🌋🐢',    rarity:'S',   hp:380,  atk:38,  def:18, spd:7, crit:0.25,
    ...
    skills:[
      ...
      { name:'火山爆发', type:'magic', hits:5, power:0, pierce:0, cd:4, atkScale:0.25, pierceScale:0.15, atkDown:{pct:20,turns:3},
        brief:'熔岩龟喷发5段，每段{N:0.25*ATK}普通+{P:0.15*ATK}穿透，减攻{atkDown.pct}%',
        detail:'熔岩龟喷发5段，每段造成 25%×(攻击力={ATK}) = {N:0.25*ATK} 普通 + 15%×ATK = {P:0.15*ATK} 穿透。\n共 {N:0.25*ATK*5} 普通 + {P:0.15*ATK*5} 穿透。\n附加减攻{atkDown.pct}%持续{atkDown.turns}回合。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'space',     name:'星际龟',   emoji:'🚀🐢',    rarity:'S',   hp:320,  atk:44,  def:12, spd:16, crit:0.25,
    ...
    skills:[
      ...
      { name:'流星暴击', type:'starMeteor', hits:1, power:0, pierce:0, cd:4, atkScale:0.6, aoe:true, energyConsumePct:50, defDown:{pct:15,turns:2},
        brief:'全体敌方{N:0.6*ATK}+50%星能转穿透，减防15%',
        detail:'星际龟对全体敌方造成 60%×(攻击力={ATK}) = {N:0.6*ATK} 普通伤害。\n消耗当前50%星能转为穿透伤害（平均分配）。\n施加防御-15% 2回合。\n冷却4回合。' },
    ]},
  // SS级
