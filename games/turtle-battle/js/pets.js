...
const ALL_PETS = [
  ...
  { id:'ghost',     name:'幽灵龟',   emoji:'👻🐢',    rarity:'B',   hp:300,  atk:42,  def:9,  spd:14, crit:0.25,
    ...
    passive:{ type:'ghostCurse', hpPct:10, turns:3, desc:'死亡时诅咒全体敌人{turns}回合，每回合受到 10%×(最大HP) = {D:HP*0.1} 穿透持续伤害' },
    skills:[
      { name:'幽魂触碰', type:'ghostTouch', hits:1, power:0, pierce:0, cd:0, normalScale:0.5, pierceScale:1.0,
        brief:'幽灵龟灵体攻击，{N:0.5*ATK}普伤+{P:1.0*ATK}穿透',
        detail:'幽灵龟用灵体触碰敌人。\n造成 50%×(攻击力={ATK}) = {N:0.5*ATK} 普通伤害 + 100%×(攻击力={ATK}) = {P:1.0*ATK} 穿透伤害。' },
      { name:'虚化', type:'ghostPhase', hits:1, power:0, pierce:0, cd:3, shieldScale:0.8, dodgePct:60, dodgeTurns:2,
        brief:'幽灵龟虚化，获得{dodgePct}%闪避{dodgeTurns}回合 + {S:0.8*ATK}护盾',
        detail:'幽灵龟身体虚化。\n获得 {dodgePct}% 闪避率，持续{dodgeTurns}回合。\n同时获得 80%×(攻击力={ATK}) = {S:0.8*ATK} 护盾。\n冷却{cd}回合。' },
      { name:'灵魂风暴', type:'ghostStorm', hits:5, power:0, pierce:0, cd:4, pierceScale:0.28, dotScale:0.1, dotTurns:3,
        brief:'幽灵龟释放5段灵魂冲击，共{P:0.28*ATK*5}穿透，附加{D:0.1*ATK}持续伤害{dotTurns}回合',
        detail:'幽灵龟释放灵魂风暴。\n每段造成 28%×(攻击力={ATK}) = {P:0.28*ATK} 纯穿透伤害 × 5段 = {P:0.28*ATK*5}。\n附加诅咒：每回合 10%×(攻击力={ATK}) = {D:0.1*ATK} 持续伤害，持续{dotTurns}回合。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'cyber',     name:'赛博龟',   emoji:'🤖🐢',    rarity:'S',   hp:330,  atk:43,  def:13, spd:15, crit:0.25,
    ...
    passive:{ type:'cyberDrone', droneScale:0.11, droneMaxAge:5, maxDrones:10, mechHpPer:30, mechAtkPer:5,
              desc:'每回合+1浮游炮（上限10），每个每回合造成 11%×(攻击力={ATK}) = {N:ATK*0.11} 普通伤害；阵亡时组装为机甲' },
    skills:[
      ...
      { name:'部署', type:'cyberDeploy', hits:1, power:0, pierce:0, cd:2,
        brief:'赛博龟立即部署1个浮游炮（每回合{N:ATK*0.11}普通伤害，上限10）',
        detail:'赛博龟立即生成1个浮游炮。\n每个浮游炮每回合对随机敌人造成 11%×(攻击力={ATK}) = {N:ATK*0.11} 普通伤害。\n最多持有10个。冷却2回合。' },
    ]},
