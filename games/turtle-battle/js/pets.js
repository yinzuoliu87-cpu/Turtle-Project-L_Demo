...
const ALL_PETS = [
  ...
  { id:'basic',     name:'小龟',     emoji:'🐢',      rarity:'C',   hp:350,  atk:40,  def:14, mr:13,crit:0.25,
    ...
    skillPool:[
      ...
      { name:'龟派气波', type:'basicChiWave', hits:3, power:0, pierce:0, cd:6, selfCast:true, atkScale:1.5,
        critGain:25, critDmgGain:20, lifestealGain:10, armorPenGain:0.1,
        brief:'自增 <span class="val-atk">+25%暴击</span> / <span class="val-atk">+20%爆伤</span> / <span class="val-heal">+10%吸血</span> / <span class="val-atk">+{N:0.1*ATK}穿甲</span> 1回合，冲到同行前排敌人面前释放气波，3段共（{N:1.5*ATK}）物理伤害',
        detail:'小龟获得 1 回合增益：\n· <span class="val-atk">+25%</span> 暴击率\n· <span class="val-atk">+20%</span> 暴击伤害\n· <span class="val-heal">+10%</span> 生命偷取\n· <span class="val-atk">+</span>（10%×攻击力 = {N:0.1*ATK}）护甲穿透\n\n冲到与自身同行（同一横排 = 同列号）的敌人面前释放龟派气波：\n· 优先命中**前排**敌人；前排阵亡时才命中后排\n· 目标被击飞至空中连击 3 段，共（150%×攻击力({ATK}) = {N:1.5*ATK}）物理伤害\n· 整个演出约 3 秒：跑位→蓄力→气波→击飞→回位\n\n冷却{cd}回合。' },
      { name:'过肩摔', type:'basicSlam', hits:1, power:0, pierce:0, cd:5, atkScale:1.0, targetHpPct:30, splashHpPct:16, splashAtkScale:0.3,
        brief:'小龟对主目标造成（{N:ATK}+30%目标最大HP）物理伤害，对其余敌人造成（{N:0.3*ATK}+16%主目标最大HP）物理伤害',
        detail:'小龟给目标来个过肩摔。\n主目标：（100%×攻击力 + 30%目标最大HP）物理伤害。\n其余敌人：（30%×攻击力 + 16%主目标最大HP）物理伤害。\n冷却{cd}回合。' },
  ...
  { id:'lava',      name:'熔岩龟',   emoji:'🌋🐢',    rarity:'S',   hp:290,  atk:40,  def:14, mr:16,crit:0.25,
    ...
    volcanoSkills:[
      { name:'烈焰重击', type:'volcanoSmash', hits:1, power:0, pierce:0, cd:0, atkScale:1.3, selfHpPct:11, lifestealPct:25,
        ...
        detail:'火山龟造成（115%×攻击力({ATK}) = {N:1.3*ATK}）+ 11%自身最大生命值 物理伤害。\n回复造成伤害的 <span class="val-heal">25%</span> 生命值。' },
