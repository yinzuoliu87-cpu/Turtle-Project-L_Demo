...
const ALL_PETS = [
  ...
  { id:'basic',     name:'小龟',     emoji:'🐢',      rarity:'C',   hp:320,  atk:38,  def:12, spd:10, crit:0.25,
    ...
    skills:[
      ...
      { name:'打击', type:'basicBarrage', hits:10, power:0, pierce:0, cd:5, atkScale:2.6,
        brief:'小龟发射10段共{N:2.6*ATK}普通伤害随机分布敌方',
        detail:'小龟对敌方发射10段攻击，随机分布。\n共 260%×(攻击力={ATK}) = {N:2.6*ATK} 普通伤害。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'lava',      name:'熔岩龟',   emoji:'🌋🐢',    rarity:'S',   hp:380,  atk:38,  def:18, spd:7, crit:0.25,
    ...
    skills:[
      { name:'熔岩喷发', type:'magic', hits:1, power:0, pierce:0, cd:0, atkScale:1.0, phoenixBurn:{turns:3, atkPct:25, hpPct:3},
        brief:'熔岩龟造成{N:ATK}普通伤害，施加灼烧3回合',
        detail:'熔岩龟对单体造成 100%×(攻击力={ATK}) = {N:ATK} 普通伤害。\n施加灼烧3回合，每回合造成 25%×ATK + 3%最大HP 伤害。' },
      { name:'岩浆护甲', type:'shield', hits:1, power:0, pierce:0, cd:3, shieldAtkScale:0.95, shieldDuration:3,
        brief:'熔岩龟获得{S:0.95*ATK}护盾，持续3回合',
        detail:'熔岩龟获得 95%×(攻击力={ATK}) = {S:0.95*ATK} 护盾，持续3回合。\n冷却{cd}回合。' },
      { name:'火山爆发', type:'magic', hits:5, power:0, pierce:0, cd:4, aoe:true, atkScale:0.16, pierceScale:0.08, phoenixBurn:{turns:3, atkPct:15, hpPct:3},
        brief:'熔岩龟对全体敌方每人喷发5段，每段{N:0.16*ATK}普通+{P:0.08*ATK}穿透，施加灼烧3回合',
        detail:'熔岩龟对全体敌方每人喷发5段。\n每段造成 16%×(攻击力={ATK}) = {N:0.16*ATK} 普通 + 8%×ATK = {P:0.08*ATK} 穿透。\n施加灼烧3回合（每回合15%ATK+3%HP）。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'crystal',   name:'水晶龟',   emoji:'🔮🐢',    rarity:'S',   hp:350,  atk:40,  def:19, spd:11, crit:0.25,
    ...
    skills:[
      ...
      { name:'水晶壁垒', type:'shield', hits:1, power:0, pierce:0, cd:3, shieldAtkScale:0.95, shieldDuration:3,
        brief:'水晶龟获得{S:0.95*ATK}护盾，持续3回合',
        detail:'水晶龟获得 95%×(攻击力={ATK}) = {S:0.95*ATK} 护盾，持续3回合。\n冷却{cd}回合。' },
      { name:'碎晶风暴', type:'magic', hits:6, power:0, pierce:0, cd:4, atkScale:0.2, pierceScale:0.1, phoenixBurn:{turns:3, atkPct:15, hpPct:3},
        brief:'水晶龟释放6段碎晶，每段{N:0.2*ATK}普通+{P:0.1*ATK}穿透，附加灼烧3回合',
