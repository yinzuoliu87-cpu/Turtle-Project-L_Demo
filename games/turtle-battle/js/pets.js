...
const ALL_PETS = [
  ...
  { id:'basic',     name:'小龟',     emoji:'🐢',      rarity:'C',   hp:320,  atk:40,  def:12, spd:10, crit:0.25,
    ...
    skills:[
      { name:'攻击', type:'physical', hits:2, power:0, pierce:0, cd:0, atkScale:0.65, selfAtkUpPct:{pct:17, turns:2},
        brief:'小龟攻击2段，共{N:0.65*ATK*2}普通伤害，自身攻击+17% 2回合',
        detail:'小龟对单体打击2段，每段 65%×(攻击力={ATK}) = {N:0.65*ATK} 普通伤害，共 130%×(攻击力={ATK}) = {N:0.65*ATK*2}。\n自身攻击+17% 2回合。' },
      { name:'龟盾', type:'turtleShieldBash', hits:1, power:0, pierce:0, cd:2, atkScale:1.1, shieldFromDmgPct:80,
        brief:'小龟造成{N:1.1*ATK}普通伤害，获得80%伤害值的永久护盾',
        detail:'小龟对单体造成 110%×(攻击力={ATK}) = {N:1.1*ATK} 普通伤害。\n获得造成伤害80%的永久护盾。\n冷却{cd}回合。' },
  ...
  { id:'bamboo',    name:'竹叶龟',   emoji:'🎋🐢',    rarity:'C',   hp:300,  atk:40,  def:10, spd:12, crit:0.25,
    ...
    passive:{ type:'bambooCharge', atkPct:85, selfHpPct:14, healSelfHpPct:8, hpGainAtkPct:33,
              desc:'每隔1回合充能🎋，充能回合技能释放后追加一发强化普攻：造成 {P:ATK*0.85+HP*0.14} 穿透伤害(85%ATK+14%最大HP)，回复 {H:HP*0.08} HP(8%最大HP)，并永久增加 {H:ATK*0.33} 最大生命值(33%ATK)' },
    skills:[
      ...
      { name:'自然恢复', type:'bambooHeal', hits:1, power:0, pierce:0, cd:3, healPct:13, shieldPct:14, shieldTurns:3, soloHealPct:21,
        brief:'竹叶龟回复{H:HP*0.13}HP，队友获得{S:HP*0.14}护盾3回合（无队友则回复{H:HP*0.21}）',
        detail:'竹叶龟回复 13%×(最大HP={HP}) = {H:HP*0.13} HP。\n为存活队友施加 14%×(最大HP={HP}) = {S:HP*0.14} 护盾，持续3回合。\n如果没有存活队友，改为回复 21%×(最大HP={HP}) = {H:HP*0.21} HP。\n冷却{cd}回合。' },
    ]},
  // B级
  ...
  { id:'two_head',  name:'双头龟',   emoji:'🐢🐢',    rarity:'B',   hp:293,  atk:49,  def:11, spd:7, crit:0.25,
    ...
    passive:{ type:'twoHeadDual', hpScale:1.5, defScale:0.2, atkLossScale:0.3, shieldScale:1.0,
              desc:'双形态切换：远程(高攻低防) ↔ 近战(+{H:ATK*1.5}HP +{D:ATK*0.2}防 -{N:ATK*0.3}攻 +{S:ATK}盾)' },
    // 远程技能组（默认）
    skills:[
  ...
  { id:'rainbow',   name:'彩虹龟',   emoji:'🌈🐢',    rarity:'A',   hp:340,  atk:40,  def:14, spd:12, crit:0.25,
    ...
    skills:[
      ...
      { name:'棱镜护盾', type:'shield', hits:1, power:0, pierce:0, cd:3, shieldAtkScale:0.8, aoeAlly:true,
        brief:'彩虹龟为全体友方施加{S:0.8*ATK}护盾',
        detail:'彩虹龟用棱镜之光保护全体友方。\n每人获得 80%×(攻击力={ATK}) = {S:0.8*ATK} 护盾。\n冷却{cd}回合。' },
