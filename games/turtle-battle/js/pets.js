...
const ALL_PETS = [
  ...
  { id:'lava',      name:'熔岩龟',   emoji:'🌋🐢',    rarity:'S',   hp:380,  atk:38,  def:18, spd:7, crit:0.25,
    ...
    skills:[
      ...
      { name:'岩浆护甲', type:'shield', hits:1, power:0, pierce:0, cd:3, shieldAtkScale:1.05, shieldDuration:3,
        brief:'熔岩龟获得{S:1.05*ATK}护盾，持续3回合',
        detail:'熔岩龟获得 105%×(攻击力={ATK}) = {S:1.05*ATK} 护盾，持续3回合。\n冷却{cd}回合。' },
  ...
  { id:'crystal',   name:'水晶龟',   emoji:'🔮🐢',    rarity:'S',   hp:350,  atk:40,  def:21, spd:11, crit:0.25,
    ...
    skills:[
      ...
      { name:'水晶壁垒', type:'shield', hits:1, power:0, pierce:0, cd:3, shieldAtkScale:1.05, shieldDuration:3,
        brief:'水晶龟获得{S:1.05*ATK}护盾，持续3回合',
        detail:'水晶龟获得 105%×(攻击力={ATK}) = {S:1.05*ATK} 护盾，持续3回合。\n冷却{cd}回合。' },
