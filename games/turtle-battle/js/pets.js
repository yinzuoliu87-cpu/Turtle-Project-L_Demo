  ...
  { id:'bamboo',    name:'竹叶龟',   emoji:'🎋🐢',    rarity:'C',   hp:318,  atk:40,  def:10, mr:11,crit:0.25,
    ...
    skillPool:[
      ...
      { name:'强化生长', type:'bambooCharged', passiveSkill:true, hits:0, power:0, pierce:0, cd:0,
        brief:'这是个被动技能，携带后竹叶龟充能变为：充能后释放技能时追加一发强化攻击（100%攻击力+13%最大HP 魔法伤害），回复 12% 最大生命值，并永久增加 105%攻击力 的最大生命值',
        detail:'被动技能：携带后强化竹叶龟的「生长」被动。\n\n充能后释放技能时追加强化攻击：\n造成（100%×攻击力({ATK}) + 13%×最大HP({HP})）魔法伤害\n回复 <span class="val-heal">12%</span> 最大生命值\n永久增加 105%×攻击力({ATK}) = {H:ATK*1.05} 最大生命值' },
  ...
  { id:'dice',      name:'骰子龟',   emoji:'🎲🐢',    rarity:'B',   hp:330,  atk:41,  def:11, mr:10,crit:0.25,
    ...
    skillPool:[
      ...
      { name:'真正的赌徒', type:'diceGamblerConvert', passiveSkill:true, hits:0, power:0, pierce:0, cd:0,
        brief:'这是个被动技能，携带后登场时将全部 <span class="val-def">护甲</span> 与 <span class="val-magic">魔抗</span> 转化为 <span class="val-atk">穿甲</span>（护甲→穿甲，魔抗→穿甲）',
