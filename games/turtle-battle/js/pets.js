...
const ALL_PETS = [
  ...
  { id:'basic',     name:'小龟',     emoji:'🐢',      rarity:'C',   hp:320,  atk:38,  def:12, spd:10, crit:0.25,
    ...
    skills:[
      ...
      { name:'龟盾', type:'turtleShieldBash', hits:1, power:0, pierce:0, cd:2, atkScale:1.0, shieldFromDmgPct:50,
        brief:'小龟造成{N:ATK}普通伤害，获得50%伤害值的永久护盾',
        detail:'小龟对单体造成 100%×(攻击力={ATK}) = {N:ATK} 普通伤害。\n获得造成伤害50%的永久护盾。\n冷却{cd}回合。' },
  ...
  { id:'phoenix',   name:'凤凰龟',   emoji:'🔥🐢',    rarity:'S',   hp:340,  atk:42,  def:14, spd:13, crit:0.25,
    ...
    skills:[
      ...
      { name:'熔岩盾', type:'phoenixShield', hits:1, power:0, pierce:0, cd:4, shieldScale:1.0, duration:4, counterScale:0.19,
        brief:'凤凰龟获得{S:shieldScale*ATK}熔岩护盾{duration}回合，被攻击每段反击{N:counterScale*ATK}普通伤害',
        detail:'凤凰龟获得 100%×(攻击力={ATK}) = {S:shieldScale*ATK} 熔岩护盾，持续{duration}回合。\n有护盾时被攻击的每段反击 19%×(攻击力={ATK}) = {N:counterScale*ATK} 伤害。\n冷却{cd}回合。' },
  ...
  { id:'lava',      name:'熔岩龟',   emoji:'🌋🐢',    rarity:'S',   hp:380,  atk:38,  def:18, spd:7, crit:0.25,
    ...
    skills:[
      ...
      { name:'火山爆发', type:'magic', hits:5, power:0, pierce:0, cd:4, aoe:true, atkScale:0.19, pierceScale:0.1, phoenixBurn:{turns:3, atkPct:15, hpPct:3},
        brief:'熔岩龟对全体敌方每人喷发5段，每段{N:0.19*ATK}普通+{P:0.1*ATK}穿透，施加灼烧3回合',
        detail:'熔岩龟对全体敌方每人喷发5段。\n每段造成 19%×(攻击力={ATK}) = {N:0.19*ATK} 普通 + 10%×ATK = {P:0.1*ATK} 穿透。\n施加灼烧3回合（每回合15%ATK+3%HP）。\n冷却{cd}回合。' },
    ]},
  ...
  { id:'crystal',   name:'水晶龟',   emoji:'🔮🐢',    rarity:'S',   hp:350,  atk:40,  def:21, spd:11, crit:0.25,
    ...
    skills:[
      ...
      { name:'碎晶风暴', type:'magic', hits:7, power:0, pierce:0, cd:4, atkScale:0.2, pierceScale:0.1, phoenixBurn:{turns:3, atkPct:15, hpPct:3},
        brief:'水晶龟释放7段碎晶，每段{N:0.2*ATK}普通+{P:0.1*ATK}穿透，附加灼烧3回合',
        detail:'水晶龟释放7段碎晶风暴。\n每段造成 20%×ATK = {N:0.2*ATK} 普通 + 10%×ATK = {P:0.1*ATK} 穿透。\n共 {N:0.2*ATK*7} 普通 + {P:0.1*ATK*7} 穿透。\n附加灼烧3回合（每回合15%ATK+3%HP）。\n冷却{cd}回合。' },
    ]},
