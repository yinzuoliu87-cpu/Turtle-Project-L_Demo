...
const ALL_PETS = [
  ...
  { id:'phoenix',   name:'凤凰龟',   emoji:'🔥🐢',    rarity:'S',   hp:371,  atk:46,  def:15, mr:17, spd:14, crit:0.25,
    ...
    passive:{ type:'phoenixRebirth', name:'涅槃', revivePct:25,
              brief:'凤凰龟首次死亡时浴火重生，以 {H:HP*0.25} HP复活',
  ...
  { id:'chest',     name:'宝箱龟',   emoji:'📦🐢',    rarity:'S',   hp:345,  atk:40,  def:16, mr:14, spd:10, crit:0.25,
    ...
    passive:{ type:'chestTreasure', name:'藏宝图',
              ...
              pools:[
                ...
                [
                  ...
                  { id:'phoenix',icon:'equip-phoenix-icon.png', name:'凤凰龟雕像',desc:'首次死亡时以 <span class="val-heal">55%</span> <span class="val-heal">最大生命值</span>重生', stat:'revive', pct:55 },
                ],
                // 传说池 (tier 4)
                [
    ...
    skills:[
      { name:'宝箱砸击', type:'chestSmash', hits:1, power:0, pierce:0, cd:0, atkScale:1.6,
      ...
      { name:'财宝风暴', type:'chestStorm', hits:6, power:0, pierce:0, cd:4, aoe:true, atkScale:0.15, pierceScale:0.07,
        brief:'宝箱龟对每个敌人飞射6段，每段（{N:0.15*ATK}）物理+（{T:0.07*ATK}）真实',
        detail:'宝箱龟对每个敌人飞射6段财宝。\n每段造成（15%×攻击力({ATK}) = {N:0.15*ATK}）物理 +（7%×攻击力({ATK}) = {T:0.07*ATK}）真实伤害。\n共（{N:0.15*ATK*6}）物理 +（{T:0.07*ATK*6}）真实伤害（每个敌人）。\n冷却{cd}回合。' },
    ]},
