  ...
  { id:'ice',       name:'寒冰龟',   emoji:'❄️🐢',    rarity:'B',   hp:381,  atk:39,  def:16, mr:18, spd:9, crit:0.25,
    ...
    skills:[
      ...
      { name:'冰霜', type:'iceFrost', dmgType:'magic', hits:10, power:0, pierce:0, cd:4, atkScale:0.14, mrDown:{pct:25,turns:4},
        brief:'寒冰龟先削减全体敌方 <span class="val-atk">-25%</span> 魔抗，再造成10段共 {M:0.14*ATK*10} 魔法伤害',
        detail:'寒冰龟释放冰霜，先削减全体敌方魔抗 <span class="val-atk">-25%</span>，持续4回合。\n随后对全体敌方同时造成10段伤害，每段（14%×攻击力({ATK}) = {M:0.14*ATK}）魔法伤害。\n共（140%×攻击力({ATK}) = {M:0.14*ATK*10}）魔法伤害。\n冷却{cd}回合。' },
    ]},
