...
const PET_ninja = { id:'ninja',     name:'忍者龟',   emoji:'🥷🐢',    rarity:'B',   hp:329,  atk:47,  def:9,  mr:7,crit:0.25,
    ...
    skillPool:[
      { name:'冲击',     type:'ninjaImpact', hits:1, power:0, pierce:0, cd:0, atkScale:1.3, behindScale:0.8,
      ...
      { name:'飞镖',     type:'ninjaShuriken', hits:1, power:0, pierce:0, cd:2, atkScale:1.5,
