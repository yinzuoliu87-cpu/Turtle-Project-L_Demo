...
const ALL_PETS = [
  ...
  { id:'hunter',    name:'猎人龟',   emoji:'🏹🐢',    rarity:'A',   hp:339,  atk:43,  def:13, mr:11, spd:15, crit:0.25,
    ...
    passive:{ type:'hunterKill', name:'猎杀', hpThresh:18, stealPct:20, lifesteal:10,
              ...
              desc:'猎人龟的猎杀本能。\n\n每次行动后检查，生命值低于 <span class="val-atk">18%</span> 的敌人直接斩杀。\n斩杀或击杀敌人时，窃取对方 <span class="val-atk">20%</span> 基础属性（攻击力/护甲/最大生命值），并叠加 <span class="val-heal">10%</span> 生命偷取。\n\n已猎杀 <span class="val-atk">{B:hunterKills}</span> 只敌方\n累计获得：攻击力+{N:hunterStolenAtk} 护甲+{D:hunterStolenDef} 最大生命值+{H:hunterStolenHp} 生命偷取{B:lifesteal}%' },
    skills:[
      ...
      { name:'隐蔽',     type:'hunterStealth', hits:1, power:0, pierce:0, cd:3, dmgScale:0.9, dodgePct:25, dodgeTurns:3, shieldScale:1.1, shieldTurns:3,
        brief:'猎人龟射一箭造成（{N:0.9*ATK}）物理伤害，获得 <span class="val-atk">25%</span> 闪避3回合 +（{S:1.1*ATK}）护盾',
        detail:'猎人龟对单体射一箭，造成（90%×攻击力({ATK}) = {N:0.9*ATK}）物理伤害。\n获得 <span class="val-atk">25%</span> 闪避率3回合。\n获得（110%×攻击力({ATK}) = {S:1.1*ATK}）护盾。\n冷却{cd}回合。' },
      { name:'连珠箭',   type:'hunterBarrage', dmgType:'true', hits:10, power:0, pierce:0, cd:4, arrowScale:0.16,
        brief:'猎人龟发射10根箭随机射向敌方，每根（{T:0.16*ATK}）真实伤害',
        detail:'猎人龟发射10根箭，随机分布到敌方目标。\n每根造成（16%×攻击力({ATK}) = {T:0.16*ATK}）真实伤害。\n共（160%×攻击力({ATK}) = {T:0.16*ATK*10}）真实伤害。\n冷却{cd}回合。' },
    ]},
