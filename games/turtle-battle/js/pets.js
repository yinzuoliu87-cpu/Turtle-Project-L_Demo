...
const ALL_PETS = [
  ...
  { id:'ninja',     name:'忍者龟',   emoji:'🥷🐢',    rarity:'B',   hp:290,  atk:42,  def:9,  spd:15, crit:0.25,
    ...
    skills:[
      { name:'飞镖',     type:'ninjaShuriken', hits:1, power:65, pierce:0, cd:0, atkScale:0,
        brief:'忍者龟投掷飞镖造成{N:65}普通伤害，暴击时转为穿透伤害',
        detail:'忍者龟对单体目标投掷飞镖，造成 65 普通伤害。\n暴击时，全部伤害转为 65×暴击倍率 穿透伤害（无视防御）。' },
