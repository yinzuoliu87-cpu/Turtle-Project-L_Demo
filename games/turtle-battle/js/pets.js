  ...
  { id:'bamboo',    name:'竹叶龟',   emoji:'🎋🐢',    rarity:'C',   hp:300,  atk:40,  def:10, spd:12, crit:0.25,
    ...
    skills:[
      { name:'一叶刃', type:'bambooLeaf', hits:3, power:0, pierce:0, cd:0, atkScale:0.22, selfHpPct:8,
        ...
        detail:'竹叶龟对单体甩出3片叶刃。\n每段造成 22%×(攻击力={ATK}) = {N:0.22*ATK} + 8%×(最大HP={HP}) = {N:HP*0.08} 普通伤害。\n共 {N:0.22*ATK*3+HP*0.08*3} 普通伤害。' },
      { name:'自然恢复', type:'bambooHeal', hits:1, power:0, pierce:0, cd:3, healPct:17, shieldPct:15, shieldTurns:3, soloHealPct:29,
        brief:'竹叶龟回复{H:HP*0.17}HP，队友获得{S:HP*0.15}护盾3回合（无队友则回复{H:HP*0.29}）',
        detail:'竹叶龟回复 17%×(最大HP={HP}) = {H:HP*0.17} HP。\n为存活队友施加 15%×(最大HP={HP}) = {S:HP*0.15} 护盾，持续3回合。\n如果没有存活队友，改为回复 29%×(最大HP={HP}) = {H:HP*0.29} HP。\n冷却{cd}回合。' },
    ]},
  // B级
